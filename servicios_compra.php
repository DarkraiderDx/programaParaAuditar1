...
<div id="imaCabeza">
  ...
  <div id="menu_lateral">
	...
	<div id="central2" style="margin-bottom:90px;">
     <h3 class="h1 ">Servicio de Compra</h3>
            <?php 
		  $link=conectarse();
		  $res=mysqli_query($link,"select * from servicios where tipo='compra' order by id_servicio DESC");
		  ...
		  ?>
           <div style="float:left; width:420px; ">
             <table  border="0" cellpadding="0" cellspacing="0" class="tabla_servicios1">
                <tr valign="middle">
                  <td width="44%" rowspan="5" align="left"  style=" boder-radius:5px; "><img  src="admin/servicios/<?php echo $fila['imagen']; ?>"   style="border:6px solid #FFFFFF;box-shadow: 0px 0px 2px; border-radius:2px; " width="150" height="120"/></td>
                ...
                <tr>
                  ...
                  <td height="33" colspan="2" align="left" style="padding-left:5px; font-size: 11px;" ><p><span style="font-size:11px;color:#666666; margin-left:5px;" >Publicado el: </span><?php echo $fila['fecha']; ?></p>
                    <p><span style="font-size:11px;color:#666666; margin-left:5px;" >Vigente hasta : </span><?php echo $fila['fecha']; ?><br>
