...
<div class="contenedor">
        ...
        <tr align="left">
          <td width="21%" align="center" valign="top" bgcolor="#FFFFFF" class="fondomenu2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td><h2></h2></td>
            </tr>
            <tr>
	...
	<ul class="menu">
		<li class="item1"><a href='personal.php'>Personal</a>
         ...
         <li class="item5"><a href='enviar_informacion.php'>Enviar Informacion</a></li>
          ...
          <td width="53%" align="center" valign="top"><?php include('conexion.php');
   $link=conectarse(); $usu=$_SESSION['usuario'];
   $sql=mysql_query("select * from personal where usuario='$usu'",$link);
   $fila=mysql_fetch_array($sql);?></td>
          <td width="26%" valign="top" class="fondomenu2"><?php echo'<a href="cerrar session.php">Cerrar Sesión</a>';?>
            <p><aside>
              <div class="foto"><span class="foto1"><img src="admin/registro/<?php echo $fila['imagen']; ?>" class="foto" />
              </span>
<?php
...
?>
              ...
              <?php echo $fila['apellido'];?></aside>            </p></td>
        </tr>
      </table>
