...
?>
            ...
            <p><samp class="h3">Capacitacion</samp></p>
            <table width="1100" border="1" align="center" cellpadding="0" cellspacing="0" class="comentario4"  >
                  <tr>
                    <th width="27" align="center" class="h3">Nº</th>
                <th width="110" align="left"><h3 class="h3">Tema</h3></th>
                <th><h3 class="h3">Tiempo de Duracion</h3></th>
                <th><span class="h3">Fecha de Inicio</span></th>
                <th align="center"><span class="h3">Fecha de Culminacion</span></th>
                <th align="left"><span class="h3">Expositor</span></th>
                <th align="left"><h3 class="h3">Contactos</h3></th>
                <th><span class="h3">Nombre de Archivo</span></th>
...
?>
                <tr>
                <?php if($n==0){?>
               <th height="49" valign="top" class="f1"><?php echo $n1;?></th>
                <th align="left" valign="top" class="f1"><?php echo $fila['evento']; ?></th>
                <th width="81" align="left" valign="top" class="f1">&nbsp;</th>
                <th width="81" align="left" valign="top" class="f1"><?php echo $fila['fecha_ini']; ?></th>
                <th width="82" align="left" valign="top" class="f1"><?php echo $fila['fecha_fin']; ?></th>
                <th width="50" align="left" valign="top" class="f1">&nbsp;</th>
                <th width="50" align="left" valign="top" class="f1">&nbsp;</th>
                <th width="70" valign="top
                =10px" class="f1"><?php echo $fila['nombre_archivo']; ?></th>
            
                <th width="70" valign="top
                =10px" class="f1"><?php echo '<a href="bajar_evento.php?id='.$fila['id_evento'].'"><button class="boton_act">descargar</button></a>';?></th>
              
              <?php $n=1; $n1++; }
              else if($n==1){?>
              <th width="190" height="49" align="center"><?php echo $n1;?></th>
                <th width="17" align="center" valign="top" ><?php echo $fila['evento']; ?></th>
                 <th width="81" align="left" valign="top" >&nbsp;</th>
                <th width="61" align="center" valign="top"><?php echo $fila['fecha_ini']; ?></th>
                <th width="52" align="center" valign="top"><?php echo $fila['fecha_fin']; ?></th>
                <th width="50" align="left" valign="top" >&nbsp;</th>
                <th width="50" align="left" valign="top" >&nbsp;</th>
                <th width="69" align="center" valign="top"><?php echo $fila['nombre_archivo']; ?></th>
            
                <th width="58" valign="top
                =10px" ><?php echo '<a href="bajar_evento.php?id='.$fila['id_evento'].'"><button class="boton_act">descargar</button></a>';?></th>
              <?php $n=0; $n1++; }?>
              </tr>
              <?php
}
