...
<div id="menu_lateral">
	...
	<div id="central1">
  <center><form action="pro_atualizar_galeria.php"
		        ...
		        <?php if((!isset($_GET['men'])))
		  {
            ...
            <p style="color:#990000; font-size:24px;"><?php $link=conectarse();
			$id=$_GET['id'];
			...
			?></p>
		          ...
		          <table width="454" align="center" class="comentario1">
		            
		            <tr>
                    <td colspan="2" class="alert" align="left"  height="25px;" style="margin-top:5px;  color:#0066CC; ">Formulario de Actualizacion de galeria</td>
		              <td align="left">&nbsp;</td>
		              <td>&nbsp;</td>
	                </tr>
		            <tr>
		              <td align="left">TITULO
	                  <input type="hidden" name="id" value="<?php echo $id; ?>"/></td>
		              <td><textarea name="titu" cols="40"  required class="textarea" ><?php echo $fila['titulo'];?></textarea></td>
	                </tr>
		            <tr>
		              <td width="102" height="113" align="left">DESCRIPCION</td>
		              <td width="201"><label for="select">
		                <textarea name="des" class="textarea" id="des" cols="40" rows="5"><?php echo $fila['descripcion'];?></textarea>
		              </label></td>
	                </tr>
		            <tr>
		              <td height="29" align="left">FECHA</td>
		              <td><input name="fecha_ini" class="date-picker " id="f_date_" value="<?php echo $fila['fecha'];?>" size="25" maxlength="34"></td>
	                </tr>
		            <tr>
		              <td colspan=2><label for="img"></label>
	                  IMAGENES(solo:jpg,png)
		            ...
		            <tr>
		              ...
		              <td align="center"><input name="Enviar2" type=reset value="Limpiar" class="btn"></td>
	                </tr>
	              </table>
