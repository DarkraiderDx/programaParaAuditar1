...
<div class="contenedor">
		...
		<li class="item2"><a>Personal</a>
          ...
          <td width="666" align="center" valign="top">
            <h2 style="color:#333333;">Enviar Información Administrativos
              <?php
$link=conectarse();
...
?>
            ...
            <table border="1" cellpadding="0" cellspacing="0" class="comentario1" >
              <tr class="tr">
                <th width="66" align="left"><h3 class="h3">Nombre </h3></th>
                <th width="72" align="left"><span class="h3">Apellido</span></th>
                <th width="72" align="left"><span class="h3">Correo</span></th>
                <th width="73" align="left"><span class="h3">Telefono</span></th>
                <th width="73" align="left"><span class="h3">Cargo</span></th>
                <th width="73" align="left"><span class="h3">Clave</span></th>

                <th width="62" align="left"><span class="h3">Imagen</span></th>
              </tr>
              <?php 
			  
while($fila=mysql_fetch_array($sql)){
?><form action="enviar_informacion_personal_2.php" method="post">
              <tr class="tr">
                <th width="100" height="25" align="left"><?php echo $fila['nombre'];?></th>
                <th width="100" align="left"><?php echo $fila['apellido'];?></th>
                <th width="100" align="left"><?php echo $fila['correo']; ?></th>
                <th width="100" align="left"><?php echo $fila['telefono']; ?></th>
                <th width="100" align="left"><?php echo $fila['cargo']; ?></th>
                <th width="100" align="left"><?php echo $fila['clave']; ?></th>
<input type="hidden" name="clave" value="<?php echo $fila['clave'];?>"/>
                <th width="100" align="left"><?php echo $fila['imagen']; ?></th>
              </tr>
              <tr class="tr">
                <th height="25" colspan="8" align="left"><?php echo '<a href="../admin/enviar_informacion_personal_2.php?id='.$fila['id_administracion'].'"><button class="boton_act">Enviar</button></a>';?></th>
              </tr></form>
              <?php
}
?>
            </table>
            <h2 style="color:#333333;">Enviar Información Planificacion
              <?php
...
?>			<form action="enviar_informacion_personal_2.php" method="post">
              ...
              <tr class="tr">
                <th height="25" colspan="8" align="left"><?php echo '<a href="../admin/enviar_informacion_personal_2.php?id='.$fila['id_planificacion'].'"><button class="boton_act">Enviar</button></a>';?></th>
              </tr></form>
              <?php
}
?>
          </table>
          <h2 style="color:#333333;">Enviar Información Direccion
            <?php
...
<input type="hidden" name="clave" value="<?php echo $fila['clave'];?>"/>
            ...
            <tr class="tr">
              <th height="25" colspan="8" align="left"><?php echo '<a href="../admin/enviar_informacion_personal_2.php?id='.$fila['id_direccion'].'"><button class="boton_act">Enviar</button></a>';?></th>
            </tr></form>
            <?php
}
?>
          </table>
          <h2 style="color:#333333;">Enviar Información Proyectos
            <?php
...
<input type="hidden" name="clave" value="<?php echo $fila['clave'];?>"/>
            ...
            <tr class="tr">
              <th height="25" colspan="8" align="left"><?php echo '<a href="../admin/enviar_informacion_personal_2.php?id='.$fila['id_reg_proyecto'].'"><button class="boton_act">Enviar</button></a>';?></th>
            </tr></form>
            <?php
}
?>
