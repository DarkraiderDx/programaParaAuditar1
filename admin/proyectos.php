...
?>
 ...
 <div id="menu_lateral">
	...
	<div id="central">
    <form action="procesar_proyecto.php"
           ...
           <?php if(!isset($_GET['men'])){
			...
			echo  "<center><div style='width:540px; margin-top:5px;'>".mensajes($_GET['men'],'verde')."</div></center>";
			 ...
			 ?>
   <table width="531" align="center" cellspacing="2" class="comentario1">
		            
		            <tr>
		              <td colspan="2" class="alert" align="left"  height="25px;"style="margin-top:5px; width:100%; color:#0066CC; ">Formulario de registro de Proyectos</td>
      </tr>
		            <tr>
		            ...
		            <tr>
		              ...
		              <td align="left"><textarea name="nom" cols="30"  class="textarea" required id="nom"></textarea></td>
	                </tr>
		            <tr>
		            ...
		            <tr>
		              ...
		              <td align="left" id="myDiv2"><input name="municipio" type="text" required  size="35" maxlength="34"class="input1"></td>
	                </tr>
		            <tr>
		              <td align="left">COMUNIDAD</td>
		              <td align="left" id="myDiv"><input name="comunidad" type="text" required  size="35" maxlength="34"class="input1"></td>
	                </tr>
		            <tr>
		              <td align="left">TIEMPO DE EJECUCION</td>
		              <td align="left"><input name="tiem" type="text" required id="tiem" size="35" maxlength="34"class="input1"></td>
	                </tr>
		            <tr>
		              <td align="left">BENEFICIARIO</td>
		              <td align="left"><input name="ben" type="text" required id="ben" size="35" maxlength="34" class="input1"></td>
	                </tr>
		            <tr>
		            ...
		            <tr>
		              ...
		              <td align="left"><textarea name="ob_general" class="textarea" id="ob_general" cols="30" rows="5"></textarea></td>
	                </tr>
		            <tr>
		              <td align="left">OBJETIVOS ESPECIFICOS</td>
		              <td align="left"><textarea name="ob_especificos"class="textarea" id="ob_especificos" cols="30" rows="5"></textarea></td>
	                </tr>
		            <tr>
		              <td align="left">RESULTADOS  ESPERADOS</td>
		              <td align="left"><label for="resultados"></label>
	                  <textarea class="textarea" name="resultados" id="resultados" cols="30" rows="5"></textarea></td>
	                </tr>
		            <tr>
