...
<div id="menu_lateral">
	...
	<div id="central1">
    <form method="post" action="borrar_noticia.php" name="form">
    <table width="85%" border="0" cellpadding="0" cellspacing="3" align="center" >
               <tr>
              ...
              <td width="29" align="center" valign="middle" bgcolor="#CC9900"><span style="color:#ffffff; font-size:16px; text-align: center;">Mar</span></td>
              <td width="62" align="center" valign="middle" bgcolor="#CC9900"><span style="color:#ffffff; font-size:16px; text-align: center;">Imagen</span></td>
              <td width="88"   align="center" valign="middle" bgcolor="#CC9900" ><span style="color:#ffffff; font-size:16px; text-align: center;">Fecha</span></td>
              <td width="148" align="center" valign="middle" bgcolor="#CC9900"><span style="color:#ffffff; font-size:16px; text-align: center;">Tiulares</span></td>
...
?>
         ...
         <td height="50" align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:14px;"><?php echo $n++; ?></td>
                  <td height="50" align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:14px;"><input type="checkbox" name="casilla[]" value="<?php echo $fila['id_noticias']; ?>"></td>
                  <td align="center"  width="62" style=" background:#E5E5E5;font-size:14px;word-wrap: break-word;"><img src="noticias/<?php echo $fila['imagen']; ?>" width="50" height="50"  / ></td>
