...
?>
 ...
 <div id="menu_lateral" style="width:250px;">
    ...
    <center><form action="actualizado_personal_pla.php"
		        ...
		        <?php if((!isset($_GET['men'])))
		  {
			...
			echo  "<center><div style='width:540px; margin-top:5px;'>".mensajes($_GET['men'],'verde')."</div></center>";
			   ...
			   <?php $link=conectarse();
			$id=$_GET['id'];
			$sql="select * from planificacion where id_planificacion='$id'";
            ...
            <table class="comentario1">
              <input type="hidden" name="id" value="<?php echo $id; ?>"/>
		            <tr>
                    <td colspan="6" class="alert" align="left"  height="25px;" style="margin-top:5px;  color:#0066CC; ">Formulario de Actualizacion de Personal de Planificacion</td>
              </tr>
		            <tr>
		            ...
		            <tr>
		              ...
		              <td width="201"><label for="select">
		                <input name="apel" type="text" class="input1" required id="titu3" size="30" maxlength="34" value="<?php echo $fil['apellido']; ?>">
		              </label></td>
	                </tr>
		            <tr>
		              <td align="left">EMAIL</td>
		              <td align="left"><input name="correo" type="email" required id="correo" class="input1" size="30" maxlength="34" value="<?php echo $fil['correo']; ?>"></td>
	                </tr>
		            <tr>
		              <td align="left">TELEFONO</td>
		              <td align="left"><input name="telefono" type="text" required id="titu6" class="input1" size="30" maxlength="34" value="<?php echo $fil['telefono']; ?>"></td>
	                </tr>
		            <tr>
		              <td align="left">SKIPE</td>
		              <td align="left"><input name="skipe" class="input1" type="text" required id="titu4" size="30" maxlength="34" value="<?php echo $fil['skipe']; ?>"></td>
	                </tr>
		            <tr>
		              <td align="left">CARGO</td>
		              <td align="left"><input name="cargo"  class="input1" type="text" required id="titu2" size="30" maxlength="34" value="<?php echo $fil['cargo']; ?>"></td>
	                </tr>
		            <tr>
		              <td align="left">CLAVE</td>
		              <td align="left"><input name="clave" class="input1" type="text" required id="titu5" size="30" maxlength="34" value="<?php echo $fil['clave']; ?>"></td>
	                </tr>
		            <tr>
		              <td height="33" align="left">TIPO DE USUARIO</td>
		            ...
		            <tr>
		              <td><input name="Enviar" type=submit class="btn" value="Enviar"></td>
