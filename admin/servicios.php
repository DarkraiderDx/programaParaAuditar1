...
?>
 ...
 <div id="menu_lateral">
	...
	<div id="central1">
    <center><form action="reg_servicio.php"
            ...
            <?php if((!isset($_GET['men'])))
		  {
			...
			echo  "<center><div style='width:540px; margin-top:5px;'>".mensajes($_GET['men'],'verde')."</div></center>";
		          ...
		          <table align="center" class="comentario1">
		            ...
		            <tr>
                    <td colspan="4" class="alert" align="left"  height="25px;" style="margin-top:5px;  color:#0066CC; ">Formulario de registro de servicios</td>
		              <td align="left">&nbsp;</td>
		              <td>&nbsp;</td>
	                </tr>
		            <tr>
		              <td align="left">NOMBRE PROPIETARIO</td>
		              <td colspan="3"><input name="nom" type="text" required id="titu"  class="input1"size="35" maxlength="34"></td>
	                </tr>
		            <tr>
		              <td width="203" align="left">DEPARTAMENTO</td>
		              <td width="288" colspan="3"><label for="select"></label>
		            ...
		            <tr>
		              ...
		              <td colspan="3" align="left" id="myDiv"><select name="municipio" id="municipio">
		                  <option value="0"  >Seleccione municipio</option>
                        </select></td>
	                </tr>
		            <tr>
		              <td align="left">COMUNIDAD</td>
		              <td colspan="3" align="left" id="myDiv2"><select name="comunidad"id="comunidad" >
		                  <option value="0"  >Seleccione comunidad</option>
                        </select></td>
	                </tr>
		            <tr>
		              <td align="left">PRODUCTO</td>
		              <td colspan="3" align="left"><input name="produc" type="text"  class="input1"required id="titu3" size="35" maxlength="34"></td>
	                </tr>
		            <tr>
		              <td align="left">CANTIDAD</td>
		              <td colspan="3" align="left"><input name="cant" type="text" class="input1" required id="titu2" size="35" maxlength="34"></td>
	                </tr>
		            <tr>
