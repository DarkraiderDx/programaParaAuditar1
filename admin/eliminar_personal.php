...
<div class="contenedor">
        ...
        <tr align="left">
          <td width="261" valign="top" bgcolor="#FFFFFF" class="fondomenu2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td><h2></h2></td>
            </tr>
            <tr>
		...
		<li class="item2"><a>Personal</a>
          ...
          <td width="665" align="center" valign="top"><form action="borrar_personal.php"
...
?>
            Eliminar Usuario</h2></legend>
            <table border="0" cellpadding="0" cellspacing="0" class="comentario1" >
              <tr class="tr">
                <th width="66" align="left">&nbsp;</th>
                ...
                <th width="73" align="left"><span class="h3">Usuario</span></th>
...
?>
              <tr class="tr">
                <th width="100" align="left"><input type="checkbox" name="casilla[]" value="<?php echo $fila['id_personal']; ?>"></th>
                ...
                <th width="100" align="left"><?php echo $fila['usuario']; ?></th>
                <th width="100" align="left"><?php echo $fila['clave']; ?></th>
                <th width="100" height="25" align="left"><?php echo $fila['tipo']; ?></th>
                <th width="100" align="left"><?php echo $fila['imagen']; ?></th>
              </tr>
              <tr class="tr">
                <th height="25" colspan="9" align="left">&nbsp;</th>
              </tr>
              <?php
}
?>
            </table>
<input type="submit" class="boton_e" value="Eliminar" />
          </form></td>
          </tr>
      </table>
