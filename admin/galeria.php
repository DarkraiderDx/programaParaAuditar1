...
<div id="menu_lateral">
	...
	<div id="central1" style="margin-bottom:70px;">
   <center><form action="procesar_imagen.php"
            ...
            <?php if((!isset($_GET['men'])))
		  {
			...
			echo  "<center><div style='width:540px; margin-top:5px;'>".mensajes($_GET['men'],'verde')."</div></center>";
		          ...
		          <table align="center" class="comentario1">
		            ...
		            <tr>
                    <td colspan="2" class="alert" align="left"  height="25px;" style="margin-top:5px;  color:#0066CC; ">Formulario de registro de galeria</td>
		              <td align="left">&nbsp;</td>
		              <td>&nbsp;</td>
	                </tr>
		            <tr>
		              <td align="left">TITULO</td>
		              <td><input name="titu" type="text" required id="titu"  class="input1"size="35" maxlength="80"></td>
	                </tr>
		            <tr>
		              <td width="203" height="117" align="left">DESCRIPCION</td>
		              <td width="288"><label for="select"></label>
		                <textarea name="des" class="textarea" id="des" cols="40" rows="5"></textarea>
		              </label></td>
	                </tr>
		            <tr>
		              <td height="34" align="left">FECHA</td>
		              <td><input name="fecha_ini" id="f_date_" class="date-picker " size="25" maxlength="34"></td>
	                </tr>
