...
<div id="menu_lateral">
	...
	<div id="central1">
   <center>Eliminar Imagenes</center>
            <?php
$link=conectarse();
if((!isset($_GET['men'])))
		  {
...
?><form action="borrar_galeria.php" name="form"
            method="post" enctype="multipart/form-data" id="fomColor">
          </p>
            <table border="0" cellpadding="0" cellspacing="3" class="comentario1" align="center" >
            <tr class="tr">
             
              <td width="36"  bgcolor="#CC9900"><span style="color:#ffffff; font-size:16px; text-align: center;">Nº</span></td>
              <td width="55"  bgcolor="#CC9900"><span style="color:#ffffff; font-size:16px; text-align: center;">Marcar</span></td>
              <td width="62"  bgcolor="#CC9900"><span style="color:#ffffff; font-size:16px; text-align: center;">Imagen</span></td>
              <td width="51" bgcolor="#CC9900"><span style="color:#ffffff; font-size:16px; text-align: center;">Fecha</span></td>
              
              <td width="465" bgcolor="#CC9900"><span style="color:#ffffff; font-size:16px; text-align: center;">Titulo</span></td>
            </tr>
            <?php 
			$n=1;
...
?>
            <tr class="tr">
            <td height="59" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:14px;"><?php echo $n++; ?></td>
              <td height="59"style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:14px;"><input type="checkbox" name="casilla[]" value="<?php echo $fila['id']; ?>"></td>
              <td align="center" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:14px;"><img src="galeria/<?php echo $fila['archivo']; ?>" alt="" width="50" height="50"  / style="float:left;"></td>
              <td style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:14px;"><?php echo $fila['fecha']; ?></td>
              
              <td style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:14px;"><?php echo $fila['titulo']; ?></td>
            </tr>
            <?php
}
?>
