...
?>
 ...
 <div id="menu_lateral" style="width:250px;">
	...
	<div id="central1" style="width:67%;">
	  <center><form action="actualizado_personal_proy.php"
            ...
            <?php if((!isset($_GET['men'])))
		  {
			...
			echo  "<center><div style='width:540px; margin-top:5px;'>".mensajes($_GET['men'],'verde')."</div></center>";
		       ...
		       <?php $link=conectarse();
			$id=$_GET['id'];
			$sql="select * from reg_proyecto where id_reg_proyecto='$id'";
        ...
        <table class="comentario1">
		            <input type="hidden" name="id" class="input1" value="<?php echo $id; ?>"/>
		            <tr>
                    <td colspan="8" class="alert" align="left"  height="25px;" style="margin-top:5px;  color:#0066CC; ">Formulario de Actualizacion de Personal de Proyectos</td>
          </tr>
		            <tr>
		            ...
		            <tr>
		              <td height="38" align="left">TIPO DE USUARIO</td>
