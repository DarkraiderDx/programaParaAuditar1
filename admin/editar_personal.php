...
<title>CDE-I Centro de desarrollo y promoción economica integral</title>
	...
	<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/><link rel="stylesheet" href="css/flexslider.css" type="text/css" media="all" />
<link rel = Stylesheet  href="css/estilo.css" type="text/css"/>

	<script src='http://ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js'></script>
	<script type='text/javascript' src="js/menu_jquery.js"></script>

<script language="javascript" src="js/jquery.js" ></script><script src="js/jquery.flexslider-min.js" type="text/javascript"></script>
...
<div class="contenedor">
        ...
        <tr align="left">
          <td width="21%" valign="top" bgcolor="#FFFFFF" class="fondomenu2"><table width="40%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td><h2></h2></td>
            </tr>
            <tr>
		...
		<li class="item2"><a>Personal</a>
			<ul>
				...
				<li class="subitem2"><a href="editar_personal.php">Actualizar Personal</a></li>
                <li class="subitem2"><a href="eliminar_personal.php">Eliminar Personal</a></li>                
...
$sql=mysql_query("select * from personal",$link);
...
?>
            ...
            <table border="1" cellpadding="0" cellspacing="0" class="comentario2" >
              <tr class="tr">
                ...
                <th width="73" align="left"><h3 class="h3">Tipo</h3></th>
...
?>
              ...
              <tr class="tr">
                <th height="25" colspan="8" align="left"><?php echo '<a href="../admin/actualizar_personal.php?id='.$fila['id_personal'].'"><button class="boton_act">Editar</button></a>';?></th>
              </tr>
              <?php
	}
?>
