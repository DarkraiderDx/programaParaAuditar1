...
?>
 ...
 <div id="menu_lateral" style="width:250px;">
    ...
    Recibir Información Administrativos
              <?php
$link=conectarse();

$sql=mysql_query("select * from administracion",$link);
$infor=mysql_query("select * from informacion_des",$link);
...
<td align="center" valign="middle" bgcolor="#CC9900"><span style="color:#ffffff; font-size:13px; text-align: center;">Operacion</span> </td>
...
?><form action="rec_informacion_personal1.php" method="post">
              <tr class="tr">
              <td height="50" align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:13px;"><?php echo $n3++; ?></td>
                ...
                <td  align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:13px;"><?php echo $fila['cargo']; ?></td>
                 <td height="50" align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:13px;"><?php echo '<a href="../admin/rec_informacion_personal1.php?id='.$fila['id_administracion'].'"><button class="btn"><i class="icon-road"></i>Ver Informacion </button></a>';?></td> 
...
?>
            ...
            Recibir Información Planificacion
              <?php
...
?>
            ...
            <table border="0" cellpadding="0" cellspacing="3" width="90%" >
              <tr class="tr">
              <td align="center" valign="middle" bgcolor="#CC9900"><span style="color:#ffffff; font-size:13px; text-align: center;">Nº</span> </td>
                <th  align="left" bgcolor="#CC9900"><span style="color:#ffffff; font-size:13px; text-align: center;">Nombre </span></th>
                <th  align="left" bgcolor="#CC9900"><span style="color:#ffffff; font-size:13px; text-align: center;">Apellido</span></th>
                <th  align="left" bgcolor="#CC9900"><span style="color:#ffffff; font-size:13px; text-align: center;">Correo</span></th>
                <th  align="left" bgcolor="#CC9900"><span style="color:#ffffff; font-size:13px; text-align: center;">Telefono</span></th>
                <th  align="left" bgcolor="#CC9900"><span style="color:#ffffff; font-size:13px; text-align: center;">Cargo</span></th>
                <td align="center" valign="middle" bgcolor="#CC9900"><span style="color:#ffffff; font-size:13px; text-align: center;">Operacion</span> </td>
              </tr>
              <?php 
			  $n2=1;
...
?>			<form action="rec_informacion_personal1.php" method="post">
              <tr class="tr">
              <td height="50" align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:13px;"><?php echo $n2++; ?></td>
                <td  align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:13px;"><?php echo $fila['nombre'];?></td>
                <td  align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:13px;"><?php echo $fila['apellido'];?></td>
                <td  align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:13px;"><?php echo $fila['correo']; ?></td>
                <td  align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:13px;"><?php echo $fila['telefono']; ?></td>
                <td  align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:13px;"><?php echo $fila['cargo']; ?></td>
                <td  align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:13px;"><?php echo '<a href="../admin/rec_informacion_personal1.php?id='.$fila['id_planificacion'].'"><button class="btn"><i class="icon-road"></i>Ver Informacion </button></a>';?></td>
...
?><form action="rec_informacion_personal1.php" method="post">
            <tr class="tr">
             <td height="50" align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:13px;"><?php echo $n1++; ?></td>
              <td   align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:13px;"><?php echo $fila['nombre'];?></td>
              <td  align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:13px;"><?php echo $fila['apellido'];?></td>
              <td  align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:13px;"><?php echo $fila['correo']; ?></td>
              <td  align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:13px;"><?php echo $fila['telefono']; ?></td>
              <td  align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:13px;"><?php echo $fila['cargo']; ?></td>
              <td height="25" colspan="8" align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:13px;"><?php echo '<a href="../admin/rec_informacion_personal1.php?id='.$fila['id_direccion'].'"><button class="btn"><i class="icon-road"></i>Ver Informacion </button></a>';?></td>
<input type="hidden" name="clave" value="<?php echo $fila['clave'];?>"/>
...
?><form action="rec_informacion_personal1.php" method="post">
            ...
            <td height="50" align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:13px;"><?php echo $n++; ?></td>
              ...
              <td  align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:13px;"><?php echo $fila['telefono']; ?></td>
              <td  align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:13px;"><?php echo $fila['cargo']; ?></td>
              <td  align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:13px;"><?php echo '<a href="../admin/rec_informacion_personal1.php?id='.$fila['id_reg_proyecto'].'"><button class="btn"><i class="icon-road"></i>Ver Informacion </button></a>';?></td>
