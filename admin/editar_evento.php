 ...
 <div id="menu_lateral">
    ...
    <table border="0" width="95%" cellpadding="0" cellspacing="3" >
              ...
              <td width="27" align="center" valign="middle" bgcolor="#CC9900"><span style="color:#ffffff; font-size:16px; text-align: center;">Nº</span></td>
                <td width="134" align="left"bgcolor="#CC9900"><span style="color:#ffffff; font-size:16px; text-align: center;">Evento</h3></td>
                <td width="94" align="left"bgcolor="#CC9900"><span style="color:#ffffff; font-size:16px; text-align: center;">Fecha de Publicacion</span></td>
                <td width="68" align="left"bgcolor="#CC9900"><span style="color:#ffffff; font-size:16px; text-align: center;">Fecha Limite</span></td>
               
                <td width="82" align="left" bgcolor="#CC9900"><span style="color:#ffffff; font-size:16px; text-align: center;">Operacion</td>
              </tr>
              <?php 
...
?>
              <tr >
                ...
                <td align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:14px;"><?php echo $fila['evento']; ?></td>
                <td align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:14px;"><?php echo $fila['fecha_ini']; ?></td>
                <td align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:14px;"><?php echo $fila['fecha_fin']; ?></td>
                <td align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:14px;"><?php echo '<a href="../admin/actualizar_evento.php?id='.$fila['id_evento'].'"><button class="btn"><i class="icon-edit"></i>Editar</button></a>';?></td>
