...
?>
  ...
  <div id="menu_lateral" style="width:250px;">
	...
	<div id="central1" style="width:70%">
     <form action="borrar_personal.php" name="form"
            method="post" enctype="multipart/form-data" id="fomColor">
            Eleminar personal de Administracion
...
?>
              <tr >
                ...
                <td align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:14px;"><input type="checkbox" name="casilla[]" value="<?php echo $fila['id_administracion']; ?>"></td>
                <?php if($fila['imagen']){ ?>
                  ...
                  <td align="center"  width="71" style=" background:#E5E5E5;font-size:14px;word-wrap: break-word;"><img src="registro/defecto.png" width="50" height="50"  / ></td>
                    <?php } ?>
                <td align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:14px;"><?php echo $fila['nombre']; ?>
                <input type="hidden" name="cla" id="echo <?php echo $fila['clave'];?>"></td>
