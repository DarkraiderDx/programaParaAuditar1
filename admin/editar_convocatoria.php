...
<div id="menu_lateral">
    ...
    <table width="95%" border="0" cellpadding="0" cellspacing="3" >
              ...
              <td width="31" align="center" valign="middle" bgcolor="#CC9900"><span style="color:#ffffff; font-size:16px; text-align: center;">Nº</span></td>
                <td width="316" align="left"bgcolor="#CC9900"><span style="color:#ffffff; font-size:16px; text-align: center;">Convocatorias</span></td>
                <td width="131" align="left"bgcolor="#CC9900"><span style="color:#ffffff; font-size:16px; text-align: center;">Fecha de Publicacion</span></td>
                <td width="152" align="left"bgcolor="#CC9900"><span style="color:#ffffff; font-size:16px; text-align: center;">Fecha Limite</span></td>
                
                <td width="82" align="left" bgcolor="#CC9900"><span style="color:#ffffff; font-size:16px; text-align: center;">Operacion</span></td>
              </tr>
              <?php 
...
?>
              <tr class="tr">
                ...
                <td align="center" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:14px;"> <?php echo '<a href="../admin/actualizar_convo.php?id='.$fila['id_convocatorias'].'"><button class="btn"><i class="icon-edit"></i>Editar</button></a>';?></td>
              </tr>
              <?php
}
?>
