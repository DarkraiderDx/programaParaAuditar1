...
$sql4=mysql_query("select * from administracion where clave='$us'",$link);
$fila=mysql_fetch_assoc($sql4);
...
$sql4=mysql_query("select * from administracion where clave='$us'",$link);
$fil=mysql_fetch_assoc($sql4);
$n=0;
$n1=1;
}
elseif($fila1['clave']==$us)
{
$ides=$fila1['clave'];
...
$sql=mysql_query("select * from informacion_des where clave='$ides'",$link);
$sql1=mysql_query("select * from planificacion where clave='$us'",$link);
$fil=mysql_fetch_assoc($sql1);}
elseif($fila2['clave']==$us)
{
$ides=$fila2['clave'];
...
$sql=mysql_query("select * from informacion_des where clave='$ides'",$link);
$sql2=mysql_query("select * from direccion where clave='$us'",$link);
$fil=mysql_fetch_assoc($sql2);
}
elseif($fila3['clave']==$us)
{
$ides=$fila3['clave'];
...
$sql=mysql_query("select * from informacion_des where clave='$ides'",$link);
$sql3=mysql_query("select * from reg_proyecto where clave='$us'",$link);
$fil=mysql_fetch_assoc($sql3);
}

?>
      <div align="left">Nombre:<?php echo $fil['nombre'].' '.$fil['apellido'];?></div>
      <div align="left">Cargo:<?php echo $fil['cargo'];?></div>
      ...
      <table border="0" cellpadding="0" cellspacing="3"  width="90%" >
        <tr class="tr">
          ...
          <td  align="left"bgcolor="#CC9900"><span style="color:#ffffff; font-size:13px; text-align: center;">Fecha</span></td>
          <td align="left"bgcolor="#CC9900"><span style="color:#ffffff; font-size:13px; text-align: center;">Detalle</span></td>
          <td align="left" bgcolor="#CC9900"><span style="color:#ffffff; font-size:13px; text-align: center;">Nombre Archivo</span></td>
          <td bgcolor="#CC9900"><span style="color:#ffffff; font-size:13px; text-align: center;">Archivo</span></td>
        </tr>
        <?php 
		$n1=1;
...
?>
        <tr class="tr">
          ...
          <td style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:13px;"><?php echo $n1++;?></td>
          <td align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:13px;"><?php echo $fila['fecha']; ?></td>
          <td  align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:13px;"><?php echo $fila['detalle']; ?></td>
          <td  align="left"style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:13px;"><?php echo $fila['nombre']; ?></td>
          <td style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:13px;"><?php echo '<a href="bajar_archivo.php?id='.$fila['id_informacion'].'"><button class="btn"><i class="icon-download-alt"></i>descargar</button></a>';?></td>
