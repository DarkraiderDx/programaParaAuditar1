...
<div id="menu_lateral">
    ...
    <table width="95%" border="0" cellpadding="0" cellspacing="3" >
              <tr class="tr">
              <td width="31" align="center" valign="middle" bgcolor="#CC9900"><span style="color:#ffffff; font-size:16px; text-align: center;">Nº</span></td>
                <td width="316" align="center"bgcolor="#CC9900"><span style="color:#ffffff; font-size:16px; text-align: center;">Convocatoria</span></td>
                <td width="131" align="center"bgcolor="#CC9900"><span style="color:#ffffff; font-size:16px; text-align: center;">Fecha de Recepcion</span></td>
                <td width="152" align="center"bgcolor="#CC9900"><span style="color:#ffffff; font-size:16px; text-align: center;">Nombre Archivo</span></td>
                
                <td width="82" align="center" bgcolor="#CC9900"><span style="color:#ffffff; font-size:16px; text-align: center;">Operacion</span></td>
              </tr>
              <?php 
			  $sql=mysql_query("select * from curriculun",$link);
$n=1;
while($fila=mysql_fetch_array($sql)){
?>
              <tr class="tr">
                <td align="center" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:14px;"><?php echo $n++; ?></td>
                <td align="center" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:14px;"><div style="word-wrap: break-word; width:320px;"><?php echo $fila['convocatoria']; ?></div></td>
                <td align="center" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:14px;"><?php echo $fila['fecha_recibida']; ?></td>
                <td align="center" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:14px;"><?php echo $fila['nombre_archi']; ?></td>
                
                <td align="center" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:14px;"> <?php echo '<a href="../admin/bajar_curriculun.php?id='.$fila['id_curriculun'].'"><button class="btn"><i class="icon-edit"></i>Descargar</button></a>';?></td>
              </tr>
              <?php
}
?>
