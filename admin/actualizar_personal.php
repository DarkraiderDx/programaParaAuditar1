...
?>
 ...
 <div id="menu_lateral" style="width:250px;">
    ...
    <center><form action="actualizado_personal.php"
		        ...
		        <?php if((!isset($_GET['men'])))
		  {
			...
			?>
		          ...
		          <table class="comentario1">
		            ...
		            <tr>
                    <td colspan="4" class="alert" align="left"  height="25px;" style="margin-top:5px;  color:#0066CC; ">Formulario de Actualizacion de Personal de Administracion</td>
	                </tr>
		            <tr>
		              <td align="left">NOMBRE
	                  <input type="hidden" name="id" value="<?php echo $id;?>"/></td>
		              <td><input name="nom" class="input1" type="text" required id="titu" value="<?php echo $fil['nombre']; ?>" size="30" maxlength="34"></td>
	                </tr>
		            <tr>
		              <td width="102" align="left">APELLIDO	                  
	                  <input type="hidden" name="cla" value="<?php echo $cl;?>"/></td>
		              <td width="201"><label for="select">
		                <input name="apel" class="input1" type="text" required id="titu3" size="30" maxlength="34" value="<?php echo $fil['apellido']; ?>">
		              </label></td>
	                </tr>
		            <tr>
		              <td align="left">EMAIL</td>
		              <td align="left"><input name="correo" class="input1" type="email" required id="correo" size="30" maxlength="34" value="<?php echo $fil['correo']; ?>"></td>
	                </tr>
		            <tr>
		              <td align="left">TELEFONO</td>
		              <td align="left"><input name="telefono" class="input1" type="text" required id="titu6" size="30" maxlength="34" value="<?php echo $fil['telefono']; ?>"></td>
	                </tr>
		            <tr>
		              <td align="left">SKIPE</td>
		              <td align="left"><input name="skipe" class="input1" type="text" required id="titu4" size="30" maxlength="34" value="<?php echo $fil['telefono']; ?>"></td>
	                </tr>
		            <tr>
		              <td align="left">CARGO</td>
		              <td align="left"><input name="cargo" type="text" required id="titu2" size="30" maxlength="34" class="input1" value="<?php echo $fil['cargo']; ?>"></td>
	                </tr>
		            <tr>
		              <td align="left">CLAVE</td>
		              <td align="left"><input name="clave" type="text" required id="titu5" size="30" maxlength="34" class="input1" value="<?php echo $fil['clave']; ?>"></td>
	                </tr>
		            <tr>
		              <td height="25" align="left">TIPO DE USUARIO</td>
		              <td align="left"><select name="ti" id="area">
		                <option><?php if($f['tipo_user']=='a'){ $var='Administrador'; }else{ $var='Usuario'; } echo $var; ?></option>
