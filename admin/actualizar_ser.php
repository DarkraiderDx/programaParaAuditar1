...
?>
   ...
   <center><div style=" border:1px dashed  #666666; margin-bottom:5px; "  ><div style=" border:1px dashed #666666; "> <?php  echo '<p style="color:#4e9339;font-size:17px;">SISTEMA DEL ADMINISTRADOR</p>';?></div>
     <?php if($fill['imagen']==''){?>
 ...
 <div id="menu_lateral">
	...
	<div id="central1">
   <center><form action="actualizado_ser.php"
        ...
        <legend>
			...
			?>
		          ...
		          <table align="center" class="comentario1">
		            ...
		            <tr>
                    <td colspan="4" class="alert" align="left"  height="25px;" style="margin-top:5px;  color:#0066CC; ">Formulario de Actualizacion de servicios</td>
		              <td align="left">&nbsp;</td>
		              <td>&nbsp;</td>
	                </tr>
		            <tr>
		              <td align="left">NOMBRE COMPLETO
	                  <input type="hidden" name="id" value="<?php echo $id; ?>"/></td>
		              <td colspan="3"><input name="nom" type="text" required id="titu" class="input1" size="35" maxlength="34" value="<?php echo $fil['nombre_propietario']; ?>"></td>
	                </tr>
		            <tr>
		              <td width="202" align="left">DEPARTAMENTO</td>
		              <td width="280" colspan="3"><label for="select"></label>
		                <select name="departamento"id="departamento" >
                        <option   ><?php echo $fil['departamento']; ?></option>
		            ...
		            <tr>
		              ...
		              <td colspan="3"><select name="municipio" id="municipio">
		              <option   ><?php echo $fil['municipio']; ?></option>
		            ...
		            <tr>
		              ...
		              <td colspan="3" align="left" id="myDiv"><select name="comunidad"id="comunidad" >
                      <option   ><?php echo $fil['comunidad']; ?></option>
		                <option value="0"  >Seleccione comunidad</option>
	                  </select></td>
	                </tr>
		            <tr>
		              <td align="left">PRODUCTO</td>
		              <td colspan="3" align="left"><input name="produc" type="text" class="input1" required id="titu3" size="35" maxlength="34" value="<?php echo $fil['producto'];?>"></td>
	                </tr>
		            <tr>
		              <td align="left">CANTIDAD</td>
		              <td colspan="3" align="left"><input name="cant" type="text" class="input1" required id="titu2" size="35" maxlength="34" value="<?php echo $fil['cantidad'];?>"></td>
	                </tr>
		            <tr>
		              <td align="left">TIPO</td>
		              <td colspan="3" align="left"><select name="tipo"  id="select4">
                      		                <option><?php echo $fil['tipo']; ?></option>
		                <option>venta</option>
		            ...
		            <tr>
	                  ...
	                  <textarea name="det" id="textarea" class="textarea" cols="30" rows="5"><?php echo $fil['detalle'];  ?></textarea></td>
	                </tr>
		            <tr>
		              <td align="left">FECHA DE PUBLICACION</td>
		              <td align="left"><input name="fecha_ini" class="date-picker " id="f_date_" value="<?php echo $fil['fecha'];?>" size="25" maxlength="34"></td>
		              <td align="left">FECHA FINAL</td>
		              <td align="left"><input name="fecha_fin" class="date-picker " id="f_date_2" value="<?php echo $fil['fecha_fin'];?>" size="25" maxlength="34"></td>
	                </tr>
		            <tr>
		              <td colspan=4><label for="img"></label>
		                INGRESE UNA IMAGEN(JPG,GIF)
		                  <input type="file" name="img" id="img"></td>
	                </tr>
		            <tr>
		              <td><input name="Enviar"  type="button" class="btn" value="Enviar " onClick="VerDatos()"></td>
		              <td colspan="3" align="center"><input name="Enviar2" type=reset class="btn" value="Limpiar"></td>
	                </tr>
	              </table>
