...
function VerDatos()
	{ var men='';
	var n=0;
		if((document.form.titu.value=="") )
		{
			men+="-Tiene que escribir en el campos Titulo.\n";
			n=1;
		}
		if(document.form.des.value==""){
		men+="-Tiene que escribir en el campos Descripcion.\n";
		n=1;
		}
		if(document.form.img.value==""){
		men+="-No eligio una Imagen.\n";
		n=1;
		}
		if(n==1)
		{
...
<div id="menu_lateral">
		...
		<li class="item2"><a>Galeria</a>
			<ul>
				<li class="subitem1"><a href="galeria.php">Registrar Imagen</a></li>
				<li class="subitem2"><a href="editar_galeria.php">Actualizar Imagen</a></li>
                <li class="subitem2"><a href="eliminar_galeria.php">Eliminar Imagen</a></li>
	...
	<div id="central1">
          ...
          <td width="686" align="center" valign="top">
            ...
            <center>Actualizar Imagen</center>
              <?php
$link=conectarse();
...
?>
            ...
            <table width="80%" border="0" cellpadding="0" cellspacing="3" class="comentario1" align="center" >
              <tr>
                <td width="75" bgcolor="#CC9900"><span style="color:#ffffff; font-size:16px; text-align: center;">Imagen</span></td>
                <td width="121" bgcolor="#CC9900"><span style="color:#ffffff; font-size:16px; text-align: center;">Fecha</span></td>
                <td width="863" bgcolor="#CC9900"><span style="color:#ffffff; font-size:16px; text-align: center;">Titulo</span></td>
                <td width="86" bgcolor="#CC9900"><span style="color:#ffffff; font-size:16px; text-align: center;">Operacion</span></td>
              </tr>
              <?php 
while($fila=mysql_fetch_array($sql)){
?>
              <tr >
                <td align="center" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:14px; text-align:center;"><img src="galeria/<?php echo $fila['archivo']; ?>" alt="" width="50" height="50"  / style="float:left;"></td>
                <td align="left"style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:14px;"><?php echo $fila['fecha']; ?></td>
                <td align="left"style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:14px;"><?php echo $fila['titulo']; ?></td>
                <td align="right"style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:14px;"> <?php echo '<a href="../admin/pro_edit_galeria.php?id='.$fila['id'].'"><button class="btn"><i class="icon-edit"></i>Editar</button></a>';?></td>
              </tr>
              <?php
}
?>
