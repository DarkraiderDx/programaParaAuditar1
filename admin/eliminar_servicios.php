...
?>
 ...
 <div id="menu_lateral">
	...
	<div id="central1">
	  <form action="eliminar_servicio.php" name="form"
...
$sql=mysql_query("select * from servicios order by fecha desc",$link);
	   ...
	   Eliminar un Servicio
	    <table  width="90%"border="0" cellpadding="0" cellspacing="3"  >
	      <tr class="tr">
            ...
            <td width="21" align="center" valign="middle" bgcolor="#CC9900"><span style="color:#ffffff; font-size:16px; text-align: center;">Marcar</span></td>
            <td align="left"bgcolor="#CC9900"><span style="color:#ffffff; font-size:16px; text-align: center;">Fecha</span></td>
	        <td align="left"bgcolor="#CC9900"><span style="color:#ffffff; font-size:16px; text-align: center;">Nombre propietario</span></td>
	        <td align="left"bgcolor="#CC9900"><span style="color:#ffffff; font-size:16px; text-align: center;">Departamento</span></td>
	        <td align="left"bgcolor="#CC9900"><span style="color:#ffffff; font-size:16px; text-align: center;">Municipio</span></td>
	        <td align="left" bgcolor="#CC9900"><span style="color:#ffffff; font-size:16px; text-align: center;">Producto</h3></td>
	        <td align="left" bgcolor="#CC9900"><span style="color:#ffffff; font-size:16px; text-align: center;">Cantidad</span></td>
	        <td align="left" bgcolor="#CC9900"><span style="color:#ffffff; font-size:16px; text-align: center;">Tipo</span></td>
          </tr>
	      <?php 
		  $n=1;
...
?>
          ...
          <td align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:14px;"><?php echo $n++; ?></td>
	        <td style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:14px;"><input type="checkbox" name="casilla[]" value="<?php echo $fila['id_servicio']; ?>"></td>
