...
<div id="menu_lateral">
	...
	<div id="central1">
    <form action="procesar_noticias.php"
			...
			?></p>
                  <table width="421" class="comentario1" align="center">
		            
		            <tr>
                    <td colspan="2" class="alert" align="left"  height="25px;" style="margin-top:5px;  color:#0066CC; ">Formulario de registro de Noticias</td>
		              <td align="left">&nbsp;</td>
		              <td>&nbsp;</td>
	                </tr>
		            <tr>
		              <td width="102" align="left">TITULAR</td>
		              <td width="272"><textarea name="titu"  class="textarea"cols="40" required id="titu"></textarea></td>
	                </tr>
		            <tr>
		              <td align="left">NOTICIA</td>
		              <td align="left"><textarea name="conte" cols="45" class="textarea"rows="6" required id="conte" tabindex="4"></textarea></td>
	                </tr>
		            <tr>
		            ...
		            <tr>
		              <td><input name="Enviar" type="button" value="Enviar" class="btn" onClick="VerDatos()"></td>
