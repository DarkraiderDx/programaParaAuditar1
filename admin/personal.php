...
function VerDatos()
	...
	if((form.telefono.value.length< 8) || isNaN(form.telefono.value))
	{
...
<center><form action="procesar_registro.php"
			...
			echo  "<center><div style='width:540px; margin-top:5px;'>".mensajes($_GET['men'],'verde')."</div></center>";
			 ...
			 ?>
                  ...
                  <table width="501" class="comentario1">
		            
		            <tr>
                    <td colspan="2" class="alert" align="left"  height="25px;" style="margin-top:5px;  color:#0066CC; ">Formulario de registro de Personal</td>
		              <td colspan="2" align="left">&nbsp;</td>
	                </tr>
		            <tr>
		              <td align="left">NOMBRE</td>
		              <td><input name="nom" type="text" required id="titu" size="30" class="input1" maxlength="34"></td>
	                </tr>
		            <tr>
		              <td width="181" align="left">APELLIDO</td>
		              <td width="206"><input name="apel" type="text" required id="titu2" size="30" class="input1" maxlength="34"></td>
	                </tr>
		            <tr>
		              <td align="left">EMAIL</td>
		              <td align="left"><input name="correo" type="email" required id="correo" class="input1" size="30" maxlength="34"></td>
	                </tr>
		            <tr>
		              <td align="left">TELEFONO</td>
		              <td align="left"><input name="telefono"  type="tel" class="input1"required id="telefono" size="30" maxlength="34"></td>
	                </tr>
		            <tr>
		              <td align="left">SKIPE</td>
		              <td align="left"><input name="skipe"  type="tel" class="input1" required id="skipe" size="30" maxlength="34"></td>
	                </tr>
		            <tr>
		              <td align="left">AREA DE PERSONAL</td>
		              <td align="left"><label for="select2"></label>
		                <select name="area" id="select2">
		                  <option>Administracion</option>
		                  <option>Planificacion y monitoreo</option>
		            ...
		            <tr>
		              ...
		              <td align="left"><input name="cargo" type="text" class="input1" required id="titu6" size="30" maxlength="34"></td>
	                </tr>
		            <tr>
		              <td align="left">CLAVE</td>
		              <td align="left"><input name="clave" type="text" class="input1" required id="titu5" size="30" maxlength="34"></td>
	                </tr>
		            <tr>
		              <td><label for="img"> Colocar Una Imagen</label></td>
		              <td><input type="file"   name="img" id="img"></td>
	                </tr>
		            <tr>
		              <td>TIPO DE USUARIO</td>
		              <td><select name="ti" id="area">
		                <option>Administrador</option>
		                <option>Usuario</option>
                      </select></td>
	                </tr>
		            <tr>
		              <td><input name="Enviar" class="btn"  type="button" value="Registrar" onClick="VerDatos()"></td>
