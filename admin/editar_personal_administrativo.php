...
?>
 ...
 <div id="menu_lateral" style="width:250px;">
    ...
    Editar Personal de Administracion
...
?>
         ...
         <td height="50" align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:13px;"><?php echo $n++; ?></td>
                 ...
                 <td align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5;font-size:13px; "> <?php echo '<a href="../admin/actualizar_personal.php?id='.$fila['id_administracion'].'"><button class="btn"><i class="icon-edit"></i>Editar</button></a>';?></td>
