...
$sql=mysql_query("select * from administracion where clave='$cla'",$link);
$fila=mysql_fetch_assoc($sql);

$sql1=mysql_query("select * from planificacion where clave='$cla'",$link);
$fila1=mysql_fetch_assoc($sql1);

$sql2=mysql_query("select * from direccion where clave='$cla'",$link);
$fila2=mysql_fetch_assoc($sql2);

$sql3=mysql_query("select * from reg_proyecto where clave='$cla'",$link);
$fila3=mysql_fetch_assoc($sql3);
if($cla==$fila['clave']){
?> 
      <center><form action="enviar_informacion.php"
        ...
        <legend></legend>
	          <table class="comentario1">
	            ...
	            <tr>
                <td colspan="2" class="alert" align="left"  height="25px;" style="margin-top:5px;  color:#0066CC; ">Formulario de Envio de informacion personal Administrativo</td>
	              <td colspan="2" align="left">&nbsp;</td>
                </tr>
	            <tr>
	              <td align="left">NOMBRE 
                  <input type="hidden" name="clave" value="<?php echo $cla; ?>"/></td>
	              <td><input disabled  name="nom" type="text" class="input1" required id="titu" value="<?php echo $fila['nombre'];?>" size="30" maxlength="34"></td>
                </tr>
	            <tr>
	              <td width="102" align="left">APELLIDO</td>
	              <td width="201"><input name="titu" type="text" disabled  class="input1" required id="titu3" value="<?php echo $fila['apellido'];?>" size="30" maxlength="34"></td>
                </tr>
	            <tr>
	              <td align="left">EMAIL</td>
	              <td align="left"><input name="correo" type="email" disabled  class="input1" required id="correo" value="<?php echo $fila['correo']; ?>" size="30" maxlength="34"></td>
                </tr>
	            <tr>
	              <td align="left">CARGO</td>
	              <td align="left"><input name="cargo" type="text" disabled  class="input1" required id="titu6" value="<?php echo $fila['cargo']; ?>" size="30" maxlength="34"></td>
                </tr>
	            <tr>
	              <td align="left">DETALLE</td>
	              <td align="left"><textarea name="detalle" class="textarea" cols="30" required id="titu2"></textarea></td>
                </tr>
	            <tr>
	            ...
	            <tr>
	              <td><input name="Enviar" class="btn" type=submit value="Enviar"></td>
	              <td align="center"><input name="Enviar2"  type=reset class="btn" value="Limpiar"></td>
                </tr>

              </table>
	            
        </form></center><?php }  elseif($cla==$fila1['clave']){?>
			  </h2>
            <p>&nbsp;</p>
            </legend>
        
      <center><form action="enviar_informacion.php" method="post" enctype="multipart/form-data" id="fomColor2">
            <legend>
        ...
        <table class="comentario1">
          <tr>
          <td colspan="2" class="alert" align="left"  height="25px;" style="margin-top:5px;  color:#0066CC; ">Formulario de Envio de informacion personal de Planificacion</td>
            <td colspan="2" align="left">&nbsp;</td>
          </tr>
          <tr>
            <td align="left">NOMBRE
              <input type="hidden" name="clave" value="<?php echo $cla; ?>"/></td>
            <td><input name="nom"   disabled class="input1" type="text" required id="titu4" value="<?php echo $fila1['nombre'];?>" size="30" maxlength="34"></td>
          </tr>
          <tr>
            <td width="102" align="left">APELLIDO</td>
            <td width="201"><input disabled  name="titu2" type="text" class="input1" required id="titu5" value="<?php echo $fila1['apellido'];?>" size="30" maxlength="34"></td>
          </tr>
          <tr>
            <td align="left">EMAIL</td>
            <td align="left"><input name="correo2" type="email" required id="correo2" class="input1" disabled  value="<?php echo $fila1['correo']; ?>" size="30" maxlength="34"></td>
          </tr>
          <tr>
            <td align="left">CARGO</td>
            <td align="left"><input name="titu2" type="text" disabled  class="input1" required id="titu7" value="<?php echo $fila1['cargo']; ?>" size="30" maxlength="34"></td>
          </tr>
          <tr>
            <td align="left">DETALLE</td>
            <td align="left"><textarea name="detalle" cols="30" class="textarea" required id="titu8"></textarea></td>
          </tr>
          <tr>
            <td colspan=2><label for="archivo"></label>
            <input type="file" name="archivo" id="archivo"></td>
          ...
          <tr>
            <td><input name="Enviar3" class="btn" type=submit value="Enviar"></td>
            <td align="center"><input name="Enviar3" type=reset class="btn" value="Limpiar"></td>
          </tr>
        </table>
        </form></center>
          
          <?php }  elseif($cla==$fila2['clave']){?>
			  </h2>
            <p>&nbsp;</p>
            </legend>
      ...
      <center><form action="enviar_informacion.php" method="post" enctype="multipart/form-data" id="fomColor2">
        ...
        <table class="comentario1">
          <tr>
          <td colspan="2" class="alert" align="left"  height="25px;" style="margin-top:5px;  color:#0066CC; ">Formulario de Envio de informacion personal de Direccion</td>
            <td colspan="2" align="left">&nbsp;</td>
          </tr>
          <tr>
            <td align="left">NOMBRE
              <input type="hidden" name="clave" value="<?php echo $cla; ?>"/></td>
            <td><input name="titu2" type="text" required id="titu4" value="<?php echo $fila2['nombre'];?>" size="30" maxlength="34" disabled class="input1"></td>
          </tr>
          <tr>
            <td width="102" align="left">APELLIDO</td>
            <td width="201"><input name="titu2" type="text" disabled class="input1" required id="titu5" value="<?php echo $fila2['apellido'];?>" size="30" maxlength="34"></td>
          </tr>
          <tr>
            <td align="left">EMAIL</td>
            <td align="left"><input name="correo2" type="email" disabled class="input1" required id="correo2" value="<?php echo $fila2['correo']; ?>" size="30" maxlength="34"></td>
          </tr>
          <tr>
            <td align="left">CARGO</td>
            <td align="left"><input name="titu2" type="text" disabled class="input1" required id="titu7" value="<?php echo $fila2['cargo']; ?>" size="30" maxlength="34"></td>
          </tr>
          <tr>
            <td align="left">DETALLE</td>
            <td align="left"><textarea name="detalle" class="textarea" cols="30" required id="titu8"></textarea></td>
          </tr>
          <tr>
            <td colspan=2><label for="archivo"></label>
            <input type="file" name="archivo" id="archivo"></td>
          ...
          <tr>
            <td><input name="Enviar3" type=submit value="Enviar" class="btn"></td>
            <td align="center"><input name="Enviar3" type=reset class="btn" value="Limpiar"></td>
          </tr>
        </table>
        </form></center>
          <?php }  elseif($cla==$fila3['clave']){?>
			  </h2>
            <p>&nbsp;</p>
            </legend>
      ...
      <center><form action="enviar_informacion.php" method="post" enctype="multipart/form-data" id="fomColor2">
        ...
        <table class="comentario1">
          <tr>
           <td colspan="2" class="alert" align="left"  height="25px;" style="margin-top:5px;  color:#0066CC; ">Formulario de Envio de informacion personal de Proyectos</td>
            <td colspan="2" align="left">&nbsp;</td>
          </tr>
          <tr>
            <td align="left">NOMBRE
              <input type="hidden" name="clave" value="<?php echo $cla; ?>"/></td>
            <td><input name="titu2" disabled class="input1" type="text" required id="titu4" value="<?php echo $fila3['nombre'];?>" size="30" maxlength="34"></td>
          </tr>
          <tr>
            <td width="102" align="left">APELLIDO</td>
            <td width="201"><input disabled class="input1" name="titu2" type="text" required id="titu5" value="<?php echo $fila3['apellido'];?>" size="30" maxlength="34"></td>
          </tr>
          <tr>
            <td align="left">EMAIL</td>
            <td align="left"><input disabled class="input1" name="correo2" type="email" required id="correo2" value="<?php echo $fila3['correo']; ?>" size="30" maxlength="34"></td>
          </tr>
          <tr>
            <td align="left">CARGO</td>
            <td align="left"><input name="titu2" type="text" disabled class="input1" required id="titu7" value="<?php echo $fila3['cargo']; ?>" size="30" maxlength="34"></td>
          </tr>
          <tr>
            <td align="left">DETALLE</td>
            <td align="left"><textarea name="detalle" cols="30" class="textarea" required id="titu8"></textarea></td>
          ...
          <tr>
            <td><input class="btn" name="Enviar3" type=submit value="Enviar"></td>
            <td align="center"><input name="Enviar3" type=reset class="btn" value="Limpiar"></td>
          </tr>
        </table>
        </form></center>
