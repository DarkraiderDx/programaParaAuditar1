...
<div id="menu_lateral">
    ...
    <table width="93%" border="0" cellpadding="0" cellspacing="3" align="center" >
               <tr>
              <td width="44" align="center" valign="middle" bgcolor="#CC9900"><span style="color:#ffffff; font-size:16px; text-align: center;">Nº</span></td>
              
              <td width="71" align="center" valign="middle" bgcolor="#CC9900"><span style="color:#ffffff; font-size:16px; text-align: center;">Imagen</span></td>
              <td width="157"   align="center" valign="middle" bgcolor="#CC9900" ><span style="color:#ffffff; font-size:16px; text-align: center;">Fecha</span></td>
              <td width="248" align="center" valign="middle" bgcolor="#CC9900"><span style="color:#ffffff; font-size:16px; text-align: center;">Tiulares</span></td>
               <td width="101" align="center" valign="middle" bgcolor="#CC9900"><span style="color:#ffffff; font-size:16px; text-align: center;">Operaciones</span></td>
...
$sql=mysql_query("select * from noticias",$link);
$n=1;
?>
...
?>
         ...
         <td height="50" align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:14px;"><?php echo $n++; ?></td>
                  ...
                  <td align="center"  width="71" style=" background:#E5E5E5;font-size:14px;word-wrap: break-word;"><img src="noticias/<?php echo $fila['imagen']; ?>" width="50" height="50"  / ></td>
                 ...
                 <td align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5;font-size:14px; "> <?php echo '<a href="../admin/actualizar_not.php?id='.$fila['id_noticias'].'"><button class="btn"><i class="icon-edit"></i>Editar</button></a>';?></td>
