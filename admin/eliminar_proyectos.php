...
?>
 ...
 <div id="menu_lateral">
	...
	<div id="central1">
    <form action="borrar_proyecto.php" 
   ...
   <table width="100%" border="0" cellpadding="0" cellspacing="3" >
              ...
              <td width="47" align="center" valign="middle" bgcolor="#CC9900"><span style="color:#ffffff; font-size:16px; text-align: center;">Marcar</span></td>
              ...
              <td  width="117" align="center" valign="middle" bgcolor="#CC9900"><span style="color:#ffffff; font-size:16px; text-align: center;">Comunidad</span></td>
	            ...
	            <td width="105" align="center" valign="middle" bgcolor="#CC9900"><span style="color:#ffffff; font-size:16px; text-align: center;">Tipo de proyecto</span></td>
...
?>
         ...
         <td height="50" align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:14px;"><?php echo $n++; ?></td>
          <td height="30"  style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:14px;"><input type="checkbox" name="casilla[]" value="<?php echo $fila['id_proyecto']; ?>"></td>
                  ...
                  <td align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5;font-size:14px; "><?php echo $fila['comunidad']; ?></td>
                  <td align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5;font-size:14px; "><?php echo $fila['municipio']; ?></td>
