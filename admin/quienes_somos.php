...
<div id="menu_lateral">
	...
	<ul class="menu">
        ...
        <li class="item5"><a href='estrategias.php'>Lineas de Accion</a></li>
          ...
          <td width="666" align="center" valign="top" ><p class="donde1" ><strong>Quienes Somos</strong></p>
            <div>
       <p class="donde"> El CDE-I (Centro de Desarrollo y Promoción Económica Integral),es una organización no lucrativa, dedicada a potenciar capacidades de gestión económica, social, productiva e investigación para implementar procesos de desarrollo local integral en espacios comunales, municipales, regionales, departamentales y nacionales.</p>
       <p class="donde"><img src="img/ORGANIGRAMA.png" alt="" width="591" height="348"></p></td>
