...
?>
 ...
 <div id="menu_lateral">
    ...
    <table border="0" cellpadding="0" cellspacing="3" >
              ...
              <td width="17%" align="left"bgcolor="#CC9900"><span style="color:#ffffff; font-size:16px; text-align: center;">Fecha de Publicacion</span></td>
               <td width="17%" align="left"bgcolor="#CC9900"><span style="color:#ffffff; font-size:16px; text-align: center;">Fecha de Limite</span></td>
                <td width="17%" align="left"bgcolor="#CC9900"><span style="color:#ffffff; font-size:16px; text-align: center;">Nombre del propietario</span></td>
                <td width="16%" align="left"bgcolor="#CC9900"><span style="color:#ffffff; font-size:16px; text-align: center;">Departamento</span></td>
                <td width="16%" align="left"bgcolor="#CC9900"><span style="color:#ffffff; font-size:16px; text-align: center;">Municipio</span></td>
                <td width="17%" align="left"bgcolor="#CC9900"><span style="color:#ffffff; font-size:16px; text-align: center;">Producto</span></td>
                <td width="17%" align="left"bgcolor="#CC9900"><span style="color:#ffffff; font-size:16px; text-align: center;">Cantidad</span></td>
                <td width="12%" align="left"bgcolor="#CC9900"><span style="color:#ffffff; font-size:16px; text-align: center;">Tipo</span></td>
                <td width="5%" align="left" bgcolor="#CC9900"><span style="color:#ffffff; font-size:16px; text-align: center;">Operacion</span></td>
              </tr>
              <?php 
			  $sql=mysql_query("select * from servicios order by fecha_fin desc",$link);
$n=1;
while($fila=mysql_fetch_array($sql)){
?>
              <tr class="tr">
                <td align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:14px;"><?php echo $n++; ?></td>
                <td align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:14px;"><?php echo $fila['fecha']; ?></td>
                <td align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:14px;"><?php echo $fila['fecha_fin']; ?></td>
                <td align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:14px;"><?php echo $fila['nombre_propietario']; ?></td>
                ...
                <td align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:14px;"><?php echo $fila['producto']; ?></td>
                <td align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:14px;"><?php echo $fila['cantidad']; ?></td>
                <td align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:14px;"><?php echo $fila['tipo']; ?></td>
                <td align="right" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:14px;"> <?php echo '<a href="../admin/actualizar_ser.php?id='.$fila['id_servicio'].'"><button class="btn"><i class="icon-edit"></i>Editar</button></a>';?></td>
              </tr>
              <?php
}
?>
