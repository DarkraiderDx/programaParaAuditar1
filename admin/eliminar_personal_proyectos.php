...
?>
  ...
  <div id="menu_lateral" style="width:250px;">
	...
	<div id="central1" style="width:70%">
     <form action="borrar_personal_proyecto.php" name="form"
            method="post" enctype="multipart/form-data" id="fomColor">
            Eleminar personal de Proyectos<?php if((!isset($_GET['men'])))
		  {
...
?>
              <tr >
                ...
                <td align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:14px;"><input type="checkbox" name="casilla[]" value="<?php echo $fila['id_reg_proyecto']; ?>"></td>
                <?php if($fila['imagen']){ ?>
