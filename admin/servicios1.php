...
<div class="contenedor">
		...
		<ul>
          ...
          <td width="666" align="center" valign="top"><form action="reg_servicio.php"
            method="post" enctype="multipart/form-data" id="fomColor">
		       
            <legend>
            <h2 style="color:#333333;">Registrar un Servicio</h2></legend>
		          <table class="comentario1">
		            ...
		            <tr>
		              ...
		              <td><input name="nom" type="text" required id="titu" size="35" maxlength="34"></td>
	                </tr>
		            <tr>
		            ...
		            <tr>
		              ...
		              <td align="left"><input name="produc" type="text" required id="titu3" size="35" maxlength="34"></td>
	                </tr>
		            <tr>
		              <td align="left">CANTIDAD</td>
		              <td align="left"><input name="cant" type="text" required id="titu2" size="35" maxlength="34"></td>
	                </tr>
		            <tr>
		            ...
		            <tr>
	                  ...
	                  <textarea name="det" id="textarea" cols="30" rows="5"></textarea></td>
	                </tr>
		            <tr>
