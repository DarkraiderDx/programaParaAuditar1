...
?>
 ...
 <div id="menu_lateral" style="width:250px;">
   ...
   Enviar Información al Personal de Administrativos
              <?php


$sql=mysql_query("select * from administracion",$link);
...
?>
            ...
            <table border="0" cellpadding="0" cellspacing="3" width="90%"  >
              ...
              <td align="center" valign="middle" bgcolor="#CC9900"><span style="color:#ffffff; font-size:13px; text-align: center;">Nº</span> </td>
                ...
                <td  align="left"bgcolor="#CC9900"><span style="color:#ffffff; font-size:13px; text-align: center;">Nombre </span></td>
                <td  align="left" bgcolor="#CC9900"><span style="color:#ffffff; font-size:13px; text-align: center;">Apellido</span></td>
                <td  align="left" bgcolor="#CC9900"><span style="color:#ffffff; font-size:13px; text-align: center;">Correo</span></td>
                <td  align="left" bgcolor="#CC9900"><span style="color:#ffffff; font-size:13px; text-align: center;">Telefono</span></td>
                <td  align="left" bgcolor="#CC9900"><span style="color:#ffffff; font-size:13px; text-align: center;">Cargo</span></td>
                <td  align="left" bgcolor="#CC9900"><span style="color:#ffffff; font-size:13px; text-align: center;">Clave</span></td>
                <td  align="left" bgcolor="#CC9900"><span style="color:#ffffff; font-size:13px; text-align: center;">Operacion</span></td>
...
?><form action="enviar_informacion_personal_2.php" method="get">
              <tr class="tr"> 
              <td  align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:13px;"><?php echo $n1++; ?></td>
...
<input type="hidden" name="clave" value="<?php echo $fila['clave'];?>"/>
                <th  align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:13px;"><?php echo '<a href="../admin/enviar_informacion_personal_2.php?id='.$fila['id_administracion'].'"><button class="btn"><i class="icon-edit"></i>Enviar</button></a>';?></td>
              </tr>
              </form>
              <?php
}
?>
           ...
           Enviar Información al Personal de Planificacion
              <?php
...
?>			<form action="enviar_informacion_personal_2.php" method="get">
              <tr class="tr">
              <td  align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:13px;"><?php echo $n2++; ?></td>
                <td  align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:13px;"><?php echo $fila['nombre'];?></td>
                <td  align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:13px;"><?php echo $fila['apellido'];?></td>
                <td  align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:13px;"><?php echo $fila['correo']; ?></td>
                <td align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:13px;"><?php echo $fila['telefono']; ?></td>
                ...
                <td  align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:13px;"><?php echo '<a href="../admin/enviar_informacion_personal_2.php?id='.$fila['id_planificacion'].'"><button class="btn"><i class="icon-edit"></i>Enviar</button></a>';?></td>
              </tr><input type="hidden" name="clave" value="<?php echo $fila['clave'];?>"/>
              </form>
              <?php
}
?>
          </table>
          Enviar Información al Personal de Direccion
            <?php


$sql=mysql_query("select * from direccion",$link);
...
?>
          ...
          <table border="0" cellpadding="0" cellspacing="3" width="90%" >
            <tr class="tr">
            <td align="center" valign="middle" bgcolor="#CC9900"><span style="color:#ffffff; font-size:13px; text-align: center;">Nº</span> </td>
              <td  align="left" bgcolor="#CC9900"><span style="color:#ffffff; font-size:13px; text-align: center;"><span class="h3">Nombre </span></td>
              <td  align="left" bgcolor="#CC9900"><span style="color:#ffffff; font-size:13px; text-align: center;"><span class="h3">Apellido</span></td>
              <td  align="left" bgcolor="#CC9900"><span style="color:#ffffff; font-size:13px; text-align: center;"><span class="h3">Correo</span></td>
              <td  align="left" bgcolor="#CC9900"><span style="color:#ffffff; font-size:13px; text-align: center;"><span class="h3">Telefono</span></td>
              <td  align="left" bgcolor="#CC9900"><span style="color:#ffffff; font-size:13px; text-align: center;"><span class="h3">Cargo</span></td>
              <td  align="left" bgcolor="#CC9900"><span style="color:#ffffff; font-size:13px; text-align: center;"><span class="h3">Clave</span></td>

              <td  align="left" bgcolor="#CC9900"><span style="color:#ffffff; font-size:13px; text-align: center;"><span class="h3">Operacion</span></td>
            </tr>
            <?php 
			$n3=1;
while($fila=mysql_fetch_array($sql)){
?><form action="enviar_informacion_personal_2.php" method="get">
            <tr class="tr">
            <td  align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:13px;"><?php echo $n3++; ?></td>
              <td  align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:13px;"><?php echo $fila['nombre'];?></td>
              <td  align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:13px;"><?php echo $fila['apellido'];?></td>
              <td  align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:13px;"><?php echo $fila['correo']; ?></td>
              <td  align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:13px;"><?php echo $fila['telefono']; ?></td>
              ...
              <td  align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:13px;"><?php echo $fila['clave']; ?></td>
<input type="hidden" name="clave" value="<?php echo $fila['clave'];?>"/>
              <td  align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:13px;"><?php echo '<a href="../admin/enviar_informacion_personal_2.php?id='.$fila['id_direccion'].'"><button class="btn"><i class="icon-edit"></i>Enviar</button></a>';?></td>
            </tr>
            </form>
            <?php
}
?>
          ...
          Enviar Información al Personal de Proyectos
            <?php


$sql=mysql_query("select * from reg_proyecto",$link);
...
?><form action="enviar_informacion_personal_2.php" method="get">
            <tr class="tr">
            <td  align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:13px;"><?php echo $n4++; ?></td>
              <td align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:13px;"><?php echo $fila['nombre'];?></td>
              <td align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:13px;"><?php echo $fila['apellido'];?></td>
              <td align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:13px;"><?php echo $fila['correo']; ?></td>
              <td align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:13px;"><?php echo $fila['telefono']; ?></td>
              ...
              <td align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:13px;"><?php echo $fila['clave']; ?></td>
<input type="hidden" name="clave" value="<?php echo $fila['clave'];?>"/>
              <td  align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:13px;"><?php echo '<a href="../admin/enviar_informacion_personal_2.php?id='.$fila['id_reg_proyecto'].'"><button class="btn"><i class="icon-edit"></i>Enviar</button></a>';?></td>
            </tr>
            </form>
            <?php
}
