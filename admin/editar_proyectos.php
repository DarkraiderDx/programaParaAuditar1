...
?>
 ...
 <div id="menu_lateral">
   ...
   <table width="100%" border="0" cellpadding="0" cellspacing="3" >
              ...
              <td width="47" align="center" valign="middle" bgcolor="#CC9900"><span style="color:#ffffff; font-size:16px; text-align: center;">Fecha</span></td>
              <td   align="center" valign="middle" bgcolor="#CC9900" ><span style="color:#ffffff; font-size:16px; text-align: center;">Proyecto</span></td>
              <td width="66" align="center" valign="middle" bgcolor="#CC9900"><span style="color:#ffffff; font-size:16px; text-align: center;">Departamento</span></td>
              <td  width="117" align="center" valign="middle" bgcolor="#CC9900"><span style="color:#ffffff; font-size:16px; text-align: center;">Comunidad</span></td>
	            <td width="91" align="center" valign="middle"bgcolor="#CC9900"><span style="color:#ffffff; font-size:16px; text-align: center;">Municipio</span></td>
                <td width="91" align="center" valign="middle"bgcolor="#CC9900"><span style="color:#ffffff; font-size:16px; text-align: center;">Beneficiarios</span></td>
	            <td width="105" align="center" valign="middle" bgcolor="#CC9900"><span style="color:#ffffff; font-size:16px; text-align: center;">Tipo de proyecto</span></th>
	            <td width="70" align="center" valign="middle"bgcolor="#CC9900"><span style="color:#ffffff; font-size:14px; text-align: center;">Operacion</span></td>
...
$sql=mysql_query("select * from proyectos",$link);
...
?>
                <tr >
         <td height="50" align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:14px;"><?php echo $n++; ?></td>
                  <td height="50" align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:14px;"><?php echo $fila['fecha']; ?></td>
                  <td align="center" width="180" style="margin-left:2px; margin-right:2px; background:#E5E5E5;font-size:14px;word-wrap: break-word;"><div style="width:180px;word-wrap: break-word;"><?php echo $fila['nombre']; ?></div></td>
                  <td align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5;font-size:14px; "><?php echo $fila['departamento']; ?></td>
                  <td align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5;font-size:14px; "><div style="width:100px; word-wrap: break-word;"><?php echo $fila['comunidad']; ?></div></td>
                  <td align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5;font-size:14px; "><div style="width:100px; word-wrap: break-word;"><?php echo $fila['municipio']; ?></div></td>
                  <td align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:14px;"><?php echo $fila['beneficiario']; ?></td>
                  <td align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:14px;"><?php echo $fila['tipo']; ?></td>
                  <td style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:14px;">  <?php echo '<a href="../admin/actualizar_pro.php?id='.$fila['id_proyecto'].'"><button class="btn" ><i class="icon-edit"></i>Editar</button></a>';?></td>
      </tr>
                <?php
}
?>
