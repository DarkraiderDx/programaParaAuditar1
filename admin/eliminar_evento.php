...
?>
 ...
 <div id="menu_lateral">
	...
	<div id="central1">
    <form action="borrar_eventos.php" name="form"
...
?>
              <tr >
                ...
                <td align="left" style="margin-left:2px; margin-right:2px; background:#E5E5E5; font-size:14px;"><input type="checkbox" name="casilla[]" value="<?php echo $fila['id_evento']; ?>"></td>
