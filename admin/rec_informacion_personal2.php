...
<div class="contenedor">
		...
		<li class="item2"><a>Personal</a>
          ...
          <td width="666" align="center" valign="top">
            <h2 style="color:#333333;">Recibir Información Administrativos
              <?php
$link=conectarse();
...
<input type="hidden" name="clave" value="<?php echo $fila['clave'];?>"/>
              ...
              <tr class="tr">
                <th height="25" colspan="8" align="left"><?php echo '<a href="../admin/rec_informacion_personal1.php?id='.$fila['id_administracion'].'"><button class="boton_act">Enviar</button></a>';?></th>
              </tr></form>
              <?php
}
?>
            </table>
            <h2 style="color:#333333;">Recibir Información Planificacion
              <?php
...
?>			<form action="rec_informacion_personal1.php" method="post">
              ...
              <tr class="tr">
              <th height="25" colspan="8" align="left"><?php echo '<a href="../admin/rec_informacion_personal1.php?id='.$fila['id_planificacion'].'"><button class="boton_act">Enviar</button></a>';?></th>
              </tr></form>
              <?php
}
?>
          </table>
          <h2 style="color:#333333;">Recibir Información Direccion
            <?php
...
<input type="hidden" name="clave" value="<?php echo $fila['clave'];?>"/>
            ...
            <tr class="tr">
              <th height="25" colspan="8" align="left"><?php echo '<a href="../admin/rec_informacion_personal1.php?id='.$fila['id_direccion'].'"><button class="boton_act">Enviar</button></a>';?></th>
            </tr></form>
            <?php
}
?>
          </table>
          <h2 style="color:#333333;">Recibir Información Proyectos
            <?php
...
<input type="hidden" name="clave" value="<?php echo $fila['clave'];?>"/>
            ...
            <tr class="tr">
              <th height="25" colspan="8" align="left"><?php echo '<a href="../admin/rec_informacion_personal1.php?id='.$fila['id_reg_proyecto'].'"><button class="boton_act">Enviar</button></a>';?></th>
            </tr></form>
            <?php
}
?>
