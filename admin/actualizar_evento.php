...
?>
 ...
 <div id="menu_lateral">
    ...
    <?php $link=conectarse();
			...
			?>
    <form action="pro_atualizar_evento.php"
            method="post" enctype="multipart/form-data" id="fomColor">
		       <?php if(!isset($_GET['men'])){
			 }
			 else{
				echo'<center><div style="width:540px;">'.mensajes($_GET['men'],'verde').'</div></center>';	 
			//echo  '<center><div class="error" style="width:450px;color:#32CD32; ">'.$men=$_GET['men'].'</div></center>';
				 }
			 ?> 
            <legend>
            <h2 style="color:#333333;">&nbsp;</h2></legend>
      <table width="528" cellspacing="3" class="comentario1" align="center">
		            
		            <tr>
                    <td colspan="2" class="alert" align="left"  height="25px;" style="margin-top:5px;  color:#0066CC; ">Formulario de Actualizacion de Eventos</td>
		              <td align="left">&nbsp;</td>
		              <td align="left" valign="middle">&nbsp;</td>
	                </tr>
		            <tr>
		              <td height="44" align="left">TEMA DE EVENTO
	                  <input type="hidden" name="id" value="<?php echo $id; ?>"/></td>
		              <td align="left" valign="middle"><textarea name="nom_evento" class="textarea" cols="35" required id="titu"><?php echo $fila['evento'];?></textarea>
		              </a></span></td>
	                </tr>
		            <tr>
		              <td width="178" height="36" align="left">TIEMPO DE DURACION</td>
		              <td width="293" align="left" valign="middle"><label for="select">
		                <input name="tiempo" type="text" required id="titu2" size="40" class="input1" maxlength="34"value="<?php echo $fila['tiempo_duracion'];?>">
		              </label></td>
	                </tr>
                    
		            <tr>
		              <td height="26" align="left">LUGAR</td>
		              <td align="left" valign="middle" id="myDiv"><input name="lugar"  class="input1"type="text" required id="titu3" size="40" maxlength="34"value="<?php echo $fila['lugar'];?>"></td>
	                </tr>
		            <tr>
		              <td height="32" align="left">FECHA DE INICIO</td>
		              <td align="left" valign="middle" id="myDiv2"><input name="fecha_ini" type="text" id="f_date_" class="date-picker"  size="40" maxlength="34" value="<?php echo $fila['fecha_ini'];?>"></td>
	                </tr>
		            <tr>
		              <td height="33" align="left">FECHA DE FINAL</td>
		              <td align="left" valign="middle" id="myDiv3"><input name="fecha_fin" type="text" id="f_date_" class="date-picker"  size="40" maxlength="34"value="<?php echo $fila['fecha_fin'];?>"></td>
	                </tr>
		            <tr>
		              <td height="29" align="left">TIPO DE EVENTO</td>
		              <td align="left"><label for="select2"></label>
		                <select name="tipo_evento" id="select2">
                        <option><?php echo $fila['tipo_evento']; ?></option>
		            ...
		            <tr>
		              <td height="92" align="left">EXPOSITOR</td>
		              <td align="left"><textarea name="expositor" class="textarea" id="expositor" cols="35" rows="5"><?php echo $fila['expositor'];?></textarea></td>
	                </tr>
		            <tr>
		              <td height="88" align="left">CONTACTAR</td>
		              <td align="left"><textarea name="contactos" id="contactos"  class="textarea"cols="35" rows="5"><?php echo $fila['contactos'];?></textarea></td>
	                </tr>
		            <tr>
		            ...
		            <tr>
		              <td><input name="Enviar" type=submit value="Enviar" class="btn"></td>
