...
<div class="contenedor">
		...
		<li class="item3"><a href="proyectos_propuestos.php" class="active">Proyectos Programados</a>
          ...
          <td width="90%" align="center" valign="top">
            <div class="servicios">
            <h2 style="color:#333333;">Proyectos Programados</h2>
            <?php 
		  $link=conectarse();
			  	$n=0;
				$n1=1;
		  
		  $res=mysql_query("select * from proyectos where tipo='propuesto'",$link);
		  ...
		  ?>
           <?php if($n==0){?>
            <table width="493" border="0" cellpadding="0" cellspacing="0" class="tabla_proyectos">
                ...
                <tr>
                  <td align="left" valign="middle"  style="background:rgba(204,204,0,0.3);"><div class="proy_td2">Nº de Beneficiarios</div></td>
              ...
              <tr>
                ...
                <tr>
                  <td colspan="2" align="center" valign="middle" bgcolor="#D6D6D6" >
                   <form  method="post" action="contactos.php"><input name="button" type="submit"  value="Contactar">
