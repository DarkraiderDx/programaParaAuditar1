...
?>
            ...
            <table  width="1000"  align="center" cellpadding="0" cellspacing="2" class="comentario4"  >
                  <tr>
...
?>
                <tr>
                <?php if($n==0){?>
               <td height="10"  class="f1" ><?php echo $n1;?></td>
                <td align="left"  class="f1"><?php echo $fila['evento']; ?></td>
                <td width="85" align="left"  class="f1"><?php echo $fila['tiempo_duracion'];?></td>
                <td width="86" align="left"  class="f1"><?php echo $fila['fecha_ini']; ?></td>
                <td width="80" align="left"  class="f1"><?php echo $fila['fecha_fin']; ?></td>
              
                <td width="83" align="center" valign="middle" class="f1"><a href="detalle_cap.php?id=<?php echo $fila['id_evento']; ?>"><button class="btn btn-success btn-small">Ver mas</button></a></td>
               
              
              <?php $n=1; $n1++; }
              else if($n==1){?>
              <td width="17"  align="center" class="f2"><?php echo $n1;?></td>
                <td width="17" align="center"   class="f2"><?php echo $fila['evento']; ?></td>
                 <td width="17" align="left"   class="f2"><?php echo $fila['tiempo_duracion'];?></td>
                <td width="17" align="center"  class="f2"><?php echo $fila['fecha_ini']; ?></td>
                <td width="17" align="center"  class="f2"><?php echo $fila['fecha_fin']; ?></td>
               
                <td width="17" align="center" valign="middle" class="f2"><a href="detalle_cap.php?id=<?php echo $fila['id_evento']; ?>"><button class="btn btn-success btn-small">Ver mas</button></a></td>
