...
<div class="contenedor">
        ...
        <tr align="left">
          <td width="260" valign="top" bgcolor="#FFFFFF" class="fondomenu2"><table width="86%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td><h2></h2></td>
            </tr>
            <tr>
              <td><div id="menu_lateral">
                ...
                <ul class="menu">
		<li class="item1"><a href="proyectos.php" class="active">Proyectos</a></li>
			
		
		<li class="item2"><a href="proyectos.php" class="active">Proyectos en Ejecucion</a>
		...
		<li class="item3"><a href="proyectos_propuestos.php">Proyectos Programados</a>
          ...
          <td width="90%" align="center" valign="top">
            ...
            <h2 style="color:#333333;">Proyectos en Ejecución</h2>
            <p>
              <?php
			   $link=conectarse();
				$n=0;
				$n1=1;
			   $query=mysql_query("select * from proyectos where tipo='ejecucion'",$link);
