...
.pro {	color: #333333;	font-weight: bold;
	font-size:12px;
}
</style>
...
<div class="contenedor">
	...
	<ul class="menu">
		...
		<li class="item3" style="text-align:left;"><a href="#">Eventos Formativos</a>
          ...
          <td width="90%" align="center" valign="top" ><div class="servicios">
		  ...
		  ?>
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tabla_servicios1">
              <tr>
                <td width="24%" rowspan="5" align="center" valign="top" bgcolor="#FBFBFB" style=" boder-radius:5px;"><img  src="admin/servicios/<?php echo $fila['imagen']; ?>" alt=""  /></td>
	...
	font-size:11px;width:230px; height:70px; padding:5px; word-wrap: break-word;"><?php echo $fila['detalle']; ?></P></td>
              ...
              <tr>
                ...
                <td width="30%"  style="padding-left:5px;"><form  method="post" action="contactos.php">
                  <input name="button" type="submit"  value="Contactar">
