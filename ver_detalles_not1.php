...
<td valign="top"><div><img src="admin/noticias/<?php echo $fila['imagen']; ?>"/class="foto_img"><?php echo $fila['texto']; ?></div></td>
          ...
          <?php }mysql_free_result($resultado); ?></td>
...
<?php $sql1=mysql_query("select * from noticias order by id_noticias desc ",$link);?>
  ...
  <div >
       ...
       <marquee direction="up" scrollamount="2" style="background-color: #FBFBFB0;  width:230px;height:300px;border:2px solid #cccccc;padding:3px" onMouseOver="this.scrollAmount='0'" onMouseOut="this.scrollAmount='2'"><br>
