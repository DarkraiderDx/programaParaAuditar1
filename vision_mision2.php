	...
	<ul class="menu">
        ...
        <li class="item5"><a href='estrategias.php'>Lineas de Accion</a></li>
          ...
          <td width="90%" align="center">
            ...
            <p class="donde1"><strong>Nuestra Vision</strong> 
            </p>
            
            <table width="90%" border="0" cellspacing="0" cellpadding="0" style="">
              <tr>
                <td><img src="img/vision.jpg" width="399" style="border:8px solid #eee;" height="292"></td>
                <td class="donde">Contribuir en la construcción de una  sociedad con justicia, solidaridad, equitativa y sin pobreza donde todas las  personas tengan las oportunidades para desarrollar sus capacidades y puedan  ejercer y gozar plenamente sus derechos y ser protagonista de su propio  desarrollo. </td>
              </tr>
            </table>
            <p class="donde1"><strong>Nuestra Mision</strong> </p>
            <table width="90%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td class="donde">Articular las  capacidades de hombres y mujeres individualmente y de las organizaciones de la  sociedad civil, sector privado institucionalizado y el estado para construir  sostenidamente políticas públicas que promueva el desarrollo comunitario  sostenible.</td>
                <td> <img src="img/mision.jpg" width="399"style="border:8px solid #eee;" height="292"></td>
              </tr>
            </table>
