...
<div id="content">
	<div id="header1"><div class="contenedorMenu">
    <div id="cabeza">
<div id="imaCabeza">
 ...
 <div id="menu_lateral">
	...
	<ul class="menu">
		<li class="item1"><a href='quienes_somos.php'  class="active"><i class="icon1-question-sign" style="margin-right:5px;"></i>Quienes Somos</a>
	...
	<div id="central1">
<center><div>    <p class="titulo_not" style="width:87%; text-align:left;"><strong>Quienes Somos</strong></p>
	...
	text-align:justify; font-size:14px;"> El CDE-I (Centro de Desarrollo y Promoción Económica Integral),es una organización no lucrativa, dedicada a potenciar capacidades de gestión económica, social, productiva e investigación para implementar procesos de desarrollo local integral en espacios comunales, municipales, regionales, departamentales y nacionales.</p>
       <p class="donde"><img src="img/ORGANIGRAMA.png" alt="" width="669" height="393"></p></div></center>
    </div><!--fin central-->
