...
<table width="100%"  style="padding:20px; background:#FFFFFF;" border="0" align="center" cellpadding="0" cellspacing="0" s>
  <tr>
    <td style="background:-moz-linear-gradient(top,#06C 0%,#09C 100%); height:40px; color:#FFFFFF; filter: progid:DXImageTransform.Microsoft.gradient(GradientType=100%,StartColorStr='#2D75BD', EndColorStr='#7891E4');"><center>
    	<h3>FORO</h3>
    </center></td>
  </tr>
  <tr>
...
<tr class="textocateg">
  <td width="15%" align="left" bgcolor="#FFFFFF" style="background:-moz-linear-gradient(top,#06C 0%,#09C 100%); height:30px; text-align:center; filter: progid:DXImageTransform.Microsoft.gradient(GradientType=100%,StartColorStr='#2D75BD', EndColorStr='#7891E4');"><a href="responder.php?tema=<?php echo $row_r_detalletema['id_msj_foro']; ?>" style="text-decoration:none; color:#FFF; font-size:16px;">Reponder el tema</a></td>
...
<?php
mysql_free_result($r_detalletema);

mysql_free_result($r_respuestas);
?>
