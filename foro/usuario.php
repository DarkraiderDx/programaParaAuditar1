...
<div id="imaCabeza">
  ...
  <div id="menu">
	...
	<div id="central3" style="width:90%;  margin-left:50px; height:400px;" >
          ...
          <form action="sesion.php?pagina=usuarios"
	...
	font-size:14px; color:#000000; text-align:center;" ><center><strong>Autentificarse</strong></center></h2>
            <p style="font-family:Verdana, Arial, Helvetica, sans-serif;
	font-size:14px; color:#000000; text-align:center;" >&nbsp;</p>
            </legend>
            
            <div style="border-radius:5px;box-shadow:rgb(204,204,204)  0px 0px 5px; padding-top:20px; padding-left:15px; width:380px; height:130px; margin:auto; box-shadow:rgb(102,102,102);"><table width="371" align="center" >
            
              <tr>
                <td width="149" align="left" nowrap="nowrap" style="font-family:Verdana, Arial, Helvetica, sans-serif;
	font-size:14px;" ><strong>Nombre de Usuario</strong></td>
                <td width="197" align="left" style=" color:#FF0000;"><input name="login" type="text" disabledrequired  class="input" id="login" placeholder="Introduzca su Usuario" size="40" maxlength="50">
                *</td>
              </tr>
              <tr>
                <td align="left" style="font-family:Verdana, Arial, Helvetica, sans-serif;
	font-size:14px;"> <strong>Contraseña</strong></td>
                <td align="left" style=" color:#FF0000;"><input name="pass" type="password" required id="pass" class="input" size="40" maxlength="50"placeholder="Introduzca su Contraseña">
                *</td>
              </tr>
              <tr>
              ...
              <tr>
                <td align="right"><input name="Enviar"   type="submit"class="btn "  value="Enviar "></td>
                <td align="left"><input name="Enviar2" type=reset class="btn " value="Limpiar"></td>
              </tr>
            </table></div>
          </form>
