...
if(isset($_FILES['archivo']))
	{
		$tipos = array("application/zip",'application/x-zip-compressed', 
'multipart/x-zip', 'application/x-compressed',"application/rar",'application/x-rar-compressed',"application/msword","application/pdf","application/vnd.openxmlformats-officedocument.wordprocessingml.document","application/vnd.ms-excel","application/vnd.openxmlformats-officedocument.spreadsheetml.sheet");
		$maximo = 100204000;		
...
<div id="imaCabeza">
  ...
  <div id="menu">
	...
	<div id="central3" style="width:90%; height:400px; margin-left:50px;  " >
  ...
  <tr>
    <td class="cuerpo"><div style="padding:2px;">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td align="center" class="textocateg"><strong>Formulario de nuevo tema </strong>&nbsp;</td>
        </tr>
        <tr>
          <td>
            <form action="<?php echo $editFormAction; ?>" method="post" enctype="multipart/form-data" name="form1" id="form1" onSubmit="return Validar(this)">
              <table width="500" align="center" cellpadding="1" cellspacing="1">
                ...
                <tr valign="baseline">
                  ...
                  <td width="393" align="left"><input name="tit_msj_foro" type="text" class="input1" size="50" /></td>
                  </tr>
                <tr valign="baseline">
                ...
                <tr valign="baseline">
                  <td align="right" nowrap="nowrap" class="textocateg"><label for="archivo">Adjuntar Archivo</label></td>
                  <td align="left"><span class="textocateg">
              ...
              <input name="idmsj_resp_msj_foro" type="hidden" id="idmsj_resp_msj_foro" value="0" />
              </form>
            </td>
        </tr>
        <tr class="textocateg">
