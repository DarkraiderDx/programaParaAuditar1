 ...
 $sql1=mysqli_query($link,"select * from noticias order by id_noticias desc ");?>
  ...
  <div style="margin-left:8px;">
       ...
       <marquee direction="up" scrollamount="2" style="background-color: #FBFBFB0; width:90%; height:500px;border:2px solid #cccccc;padding:3px" ><br>
		...
		<div style="float:left; "><img src="admin/noticias/<?php echo $fila1['imagen']; ?>" width="50" height="50"  / style=" border:4px solid #FFFFFF;float:left;"></div>
...
<p style="color:#D9412B; font-size:25px;">&nbsp;</p>
	<center><div id="central3" style="width:65%;">
      ...
      <div >
      <div class="titulo_not"><?php echo $fila['titulo'];?><div align="right" style="font-size:12px;"><?php echo $fila['fecha']; ?></div></div>
      <div>
      <div style="text-align:justify;font-size:20px; text-height:80%; text-wrap:normal;font-family:Calibri; padding-left:30px; padding-bottom:10px; padding-right:30px;"><img src="admin/noticias/<?php echo $fila['imagen']; ?>"/class="foto_img"><?php echo $fila['texto']; ?></div>
      </div>
      </div>
      <div style="clear:both;">
      </div>
      <?php $aux=1;}elseif($aux==1){?>
      
     <div>
      <div class="titulo_not"><?php echo $fila['titulo'];?><div align="right" style="font-size:12px;"><?php echo $fila['fecha']; ?></div></div>
      <div>
      <div style="text-align:justify;font-size:12px; padding-left:25px; padding-bottom:10px;  "><img src="admin/noticias/<?php echo $fila['imagen']; ?>"/class="foto_img1"><?php echo $fila['texto']; ?></div>
      </div>
      </div>
      <div style="clear:both;">
      </div>
