...
<div id="imaCabeza">
  ...
  <center></center><div style="box-shadow: 0 2px 5px #666666; margin-left:5px; border-radius:4px; width:170px; padding-left:30px; padding-right:20px; padding-bottom:20px; margin-bottom:5px; text-align:left; padding-top:20px;"><div class="label-warning" style=" height:25px;margin-top:10px; color:#FFFFFF; text-align:center;">Iniciar Session  </div><form action="entrar_usuario.php"  method="post" class="login">
	...
	<div id="central2" style="width:70%;">
          ...
          <p>&nbsp;
      <div class="alert"  ><h2 style="font-family:Verdana, Arial, Helvetica, sans-serif; color:#006600; font-size:18px; text-align: left">Personal de Administracion<span style="text-align: center"></span></h2></div>
			<?php 
      ...
      <table width="429" border="0" cellpadding="0" cellspacing="0" class="tabla_servicios" >
              <tr>
                <td width="33%" rowspan="7"align="center"><img src="admin/registro/defecto.png" alt="imagen" width="112" height="113" style="border:5px solid #FFFFFF;box-shadow: 0px 0px 10px rgba(10,20,30,.3); background:#EFEFEF;" /></td>
      ...
      <table width="429" border="0" cellpadding="0" cellspacing="0" class="tabla_servicios">
            <tr>
              <td width="33%" rowspan="7"  align="center"><img src="admin/registro/<?php echo $fila['imagen']; ?>" alt="imagen" width="112" height="113" style="border:5px solid #FFFFFF;box-shadow: 0px 0px 10px rgba(10,20,30,.3); background:#EFEFEF;" /></td>
              <td rowspan="3" ><P style="text-align:center; font-weight: bold;">&nbsp;</P></td>
              <td  style="font-size:18px;">&nbsp;</td>
              <td style="font-size:16px;">&nbsp;</td>
            </tr>
            ...
            <?php }} ?>
      <div class="alert" style="text-align:left; "><h2 style="font-family:Verdana, Arial, Helvetica, sans-serif; color:#006600; font-size:18px; text-align: left">Personal de Planificacion y Monitoreo<span style="text-align: center"></span></h2></div>
            <p>
              <?php 
      ...
      <div class="alert" ><h2 style="font-family:Verdana, Arial, Helvetica, sans-serif; color:#006600; font-size:18px; text-align: left" >Personal de Direccion</h2></div>
            <p>
              <?php 
      ...
      <div class="alert" >
              <h2 style="font-family:Verdana, Arial, Helvetica, sans-serif; color:#006600; font-size:18px; text-align: left" >Personal de Proyectos</h2>
            </div>
            <p>
              <?php 
