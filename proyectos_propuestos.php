...
<div id="imaCabeza">
  ...
  <div id="menu_lateral">
		...
		<li class="item3"><a href="proyectos_concluidos.php">Proyectos Concluidos</a>
			
		</li>
		<li class="item3"><a href="proyectos_propuestos.php" class="active">Proyectos Programados</a>
	...
	<div id="central2">
     <h3 class="h1 ">Proyectos Propuestos</h3>
             <?php 
		  $link=conectarse();
			  	$n=0;
				$n1=1;
		  
		  $res=mysqli_query($link,"select * from proyectos where tipo='propuesto'order by id_proyecto desc");
		  ...
		  ?>
           <?php if($n==0){?>
            <table width="493" border="0" cellpadding="0" cellspacing="2" class="tabla_proyectos">
                ...
                <tr>
                  <td align="left" valign="middle"  style="background:rgba(204,204,0,0.5);"><div class="proy_td2">Nº de Beneficiarios</div></td>
              ...
              <tr>
                ...
                <tr>
                  <td colspan="2" align="left" valign="middle"  >
                   <form  method="post" action="contactos.php"><input name="button"  class="btn btn-success"  type="submit"  value="Contactar">
                     <input type="hidden" name="tipo_contacto" id="hiddenField" value="<?php echo 'proyecto'.'_'.$fila['tipo'];?>">
                   </form>
              </tr>
            </table>
            <?php $n=1; $n1++; }
            ...
            <table width="493" border="0" cellpadding="0" cellspacing="2" class="tabla_proyectos">
              ...
              <tr>
                ...
                <tr>
                  <td colspan="2" align="left" valign="middle"  >
                   <form  method="post" action="contactos.php"><input name="button" type="submit" class="btn btn-success"  value="Contactar">
                     <input type="hidden" name="tipo_contacto" id="hiddenField" value="<?php echo 'proyecto'.'_'.$fila['tipo'];?>">
                   </form>
              </tr>
            </table>
