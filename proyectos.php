...
<div id="imaCabeza">
  ...
  <div id="menu_lateral">
	...
	<div id="central2">
     <h3 class="h1 ">Proyectos en Ejecución</h3>
            <p>
              <?php
			   $link=conectarse();
				$n=0;
      ...
      <table width="493" cellpadding="0" cellspacing="2" class="tabla_proyectos" >
              <tr>
                ...
                <td   align="left" style="background:#DA542E; color:#FFFFFF; padding-left:7px;text-shadow: 1px 0px 0px white, 0px 0px 0px grey;  word-wrap: break-word;" height="35px;"><div class="proy_td1" style="
