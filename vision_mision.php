  ...
  <div id="menu_lateral">
	...
	<ul class="menu">
		<li class="item1"><a href='quienes_somos.php'>Quienes Somos</a>
		 <li class="item2"><a href='vision_mision.php' class="active">Vision Mision</a></li>
	...
	<div id="central2">
            ...
            <div style="width:410px; height:485px; margin-left:2px; float:left; margin-bottom:10px; border:1px solid #666666; border-radius:5px;  padding-left:2px; padding-right:5px; padding-top:5px; padding-bottom:5px;"><p class="donde1" style="width:390px;"><strong>Nuestra Vision</strong> 
            </p>
            <img src="img/vision.jpg" width="389" style="border:8px solid #eee;" height="292">
            <div class="donde">
            Contribuir en la construcción de una  sociedad con justicia, solidaridad, equitativa y sin pobreza donde todas las  personas tengan las oportunidades para desarrollar sus capacidades y puedan  ejercer y gozar plenamente sus derechos y ser protagonista de su propio  desarrollo.
            </div>
            </div>
            <div style="width:410px;border-radius:5px;height:485px; float:left; margin-left:2px; border:1px solid #666666; padding-left:5px; padding-right:5px; padding-top:5px; padding-bottom:5px;"><p class="donde1" style="width:390px;"><strong>Nuestra Mision</strong> 
            </p>
            <img src="img/mision.jpg" width="389"style="border:8px solid #eee;" height="292">
            <div class="donde">
           Articular las  capacidades de hombres y mujeres individualmente y de las organizaciones de la  sociedad civil, sector privado institucionalizado y el estado para construir  sostenidamente políticas públicas que promueva el desarrollo comunitario  sostenible.
            </div>
            </div>
    </div><!--fin central-->
